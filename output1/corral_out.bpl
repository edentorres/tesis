...
procedure {:public} vc0x0x0_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s508: Ref);



procedure {:public} vc0x0x1_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s620: Ref);



procedure {:public} vc0x0x2_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s732: Ref);



procedure {:public} vc0x0x3_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s851: Ref);



procedure {:public} vc0x0x4_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s964: Ref);



procedure {:public} vc0x0x6_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s1082: Ref);



procedure {:public} vc0x0x7_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s1200: Ref);



procedure {:public} vc0x0x8_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s1312: Ref);



procedure {:public} vc0x0x9_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s1424: Ref);



procedure {:public} vc0x1x0_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s1563: Ref);



procedure {:public} vc0x1x1_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s1673: Ref);



procedure {:public} vc0x1x2_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s1783: Ref);



procedure {:public} vc0x1x3_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s1900: Ref);



procedure {:public} vc0x1x4_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s2011: Ref);



procedure {:public} vc0x1x6_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s2127: Ref);



procedure {:public} vc0x1x7_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s2243: Ref);



procedure {:public} vc0x1x8_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s2353: Ref);



procedure {:public} vc0x1x9_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s2463: Ref);



procedure {:public} vc0x2x0_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s2600: Ref);



procedure {:public} vc0x2x1_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s2708: Ref);



procedure {:public} vc0x2x2_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s2816: Ref);



procedure {:public} vc0x2x3_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s2931: Ref);



procedure {:public} vc0x2x4_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s3040: Ref);



procedure {:public} vc0x2x6_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s3154: Ref);



procedure {:public} vc0x2x7_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s3268: Ref);



procedure {:public} vc0x2x8_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s3376: Ref);



procedure {:public} vc0x2x9_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s3484: Ref);
  modifies Balance, auctionState_ValidatorAuction, closeTime_ValidatorAuction;



implementation {:ForceInline} vc0x2x9_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s3484: Ref)
{
  var __var_4: bool;
  var __var_5: int;
  var __var_6: bool;
  ...
  corral_source_split_30:
    call {:si_unique_call 48} transitionToAuctionFailed_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG);
...
procedure ValidatorAuction_ValidatorAuction_NoBaseCtor(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, _startPriceInWei_s3678: int, _auctionDurationInDays_s3678: int, _minimalNumberOfParticipants_s3678: int, _maximalNumberOfParticipants_s3678: int, _depositLocker_s3678: Ref);
...
implementation {:ForceInline} ValidatorAuction_ValidatorAuction_NoBaseCtor(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, _startPriceInWei_s3678: int, _auctionDurationInDays_s3678: int, _minimalNumberOfParticipants_s3678: int, _maximalNumberOfParticipants_s3678: int, _depositLocker_s3678: Ref)
{
  var __var_8: int;
  var __var_9: Ref;
  var __var_10: Ref;
  ...
  anon0:
    ...
    call {:si_unique_call 56} {:cexpr "_startPriceInWei"} boogie_si_record_sol2Bpl_int(_startPriceInWei_s3678);
    call {:si_unique_call 57} {:cexpr "_auctionDurationInDays"} boogie_si_record_sol2Bpl_int(_auctionDurationInDays_s3678);
    call {:si_unique_call 58} {:cexpr "_minimalNumberOfParticipants"} boogie_si_record_sol2Bpl_int(_minimalNumberOfParticipants_s3678);
    call {:si_unique_call 59} {:cexpr "_maximalNumberOfParticipants"} boogie_si_record_sol2Bpl_int(_maximalNumberOfParticipants_s3678);
    call {:si_unique_call 60} {:cexpr "_depositLocker"} boogie_si_record_sol2Bpl_ref(_depositLocker_s3678);
...
procedure {:constructor} {:public} ValidatorAuction_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, _startPriceInWei_s3678: int, _auctionDurationInDays_s3678: int, _minimalNumberOfParticipants_s3678: int, _maximalNumberOfParticipants_s3678: int, _depositLocker_s3678: Ref);
  modifies Balance, owner_Ownable, auctionDurationInDays_ValidatorAuction, startPrice_ValidatorAuction, minimalNumberOfParticipants_ValidatorAuction, maximalNumberOfParticipants_ValidatorAuction, Alloc, whitelist_ValidatorAuction, bids_ValidatorAuction, bidders_ValidatorAuction, startTime_ValidatorAuction, closeTime_ValidatorAuction, lowestSlotPrice_ValidatorAuction, depositLocker_ValidatorAuction, auctionState_ValidatorAuction;



implementation {:ForceInline} ValidatorAuction_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, _startPriceInWei_s3678: int, _auctionDurationInDays_s3678: int, _minimalNumberOfParticipants_s3678: int, _maximalNumberOfParticipants_s3678: int, _depositLocker_s3678: Ref)
{
  var __var_8: int;
  var __var_9: Ref;
  var __var_10: Ref;
  ...
  anon0:
    ...
    call {:si_unique_call 72} {:cexpr "_startPriceInWei"} boogie_si_record_sol2Bpl_int(_startPriceInWei_s3678);
    call {:si_unique_call 73} {:cexpr "_auctionDurationInDays"} boogie_si_record_sol2Bpl_int(_auctionDurationInDays_s3678);
    call {:si_unique_call 74} {:cexpr "_minimalNumberOfParticipants"} boogie_si_record_sol2Bpl_int(_minimalNumberOfParticipants_s3678);
    call {:si_unique_call 75} {:cexpr "_maximalNumberOfParticipants"} boogie_si_record_sol2Bpl_int(_maximalNumberOfParticipants_s3678);
    call {:si_unique_call 76} {:cexpr "_depositLocker"} boogie_si_record_sol2Bpl_ref(_depositLocker_s3678);
    ...
    call {:si_unique_call 79} ValidatorAuction_ValidatorAuction_NoBaseCtor(this, msgsender_MSG, msgvalue_MSG, _startPriceInWei_s3678, _auctionDurationInDays_s3678, _minimalNumberOfParticipants_s3678, _maximalNumberOfParticipants_s3678, _depositLocker_s3678);
    return;
}
...
implementation {:ForceInline} bid_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int)
{
  ...
  corral_source_split_53:
    ...
    call {:si_unique_call 86} slotPrice_s3809 := currentPrice_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG);
    slotPrice_s3809 := slotPrice_s3809;
    call {:si_unique_call 87} {:cexpr "slotPrice"} boogie_si_record_sol2Bpl_int(slotPrice_s3809);
  ...
  anon4_Then:
    assume {:partition} slotPrice_s3809 < lowestSlotPrice_ValidatorAuction[this];
  ...
  anon4_Else:
    assume {:partition} lowestSlotPrice_ValidatorAuction[this] <= slotPrice_s3809;
    goto anon2;
...
procedure {:public} addToWhitelist_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s3952: Ref);
  modifies M_Ref_bool;



implementation {:ForceInline} addToWhitelist_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s3952: Ref)
{
  var i_s3950: int;
  ...
  corral_source_split_96:
    assume i_s3950 >= 0;
    i_s3950 := 0;
    call {:si_unique_call 123} {:cexpr "i"} boogie_si_record_sol2Bpl_int(i_s3950);
    goto anon2_LoopHead;
  ...
  anon2_LoopBody:
    assume {:partition} i_s3950 < Length[addressesToWhitelist_s3952];
  ...
  corral_source_split_99:
    ...
    call {:si_unique_call 124} {:cexpr "whitelist[addressesToWhitelist[i]]"} boogie_si_record_sol2Bpl_bool(M_Ref_bool[whitelist_ValidatorAuction[this]][M_int_Ref[addressesToWhitelist_s3952][i_s3950]]);
  ...
  corral_source_split_101:
    assume i_s3950 >= 0;
    i_s3950 := i_s3950 + 1;
    call {:si_unique_call 125} {:cexpr "i"} boogie_si_record_sol2Bpl_int(i_s3950);
    assume i_s3950 >= 0;
    goto anon2_LoopHead;

  anon2_LoopDone:
    assume {:partition} Length[addressesToWhitelist_s3952] <= i_s3950;
    return;
}
...
implementation {:ForceInline} currentPrice_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int) returns (__ret_0_: int)
{
  ...
  corral_source_split_120:
    ...
    call {:si_unique_call 139} {:cexpr "secondsSinceStart"} boogie_si_record_sol2Bpl_int(secondsSinceStart_s4018);
    goto corral_source_split_121;

  corral_source_split_121:
    assume __var_17 >= 0;
    assume secondsSinceStart_s4018 >= 0;
    call {:si_unique_call 140} __var_17 := priceAtElapsedTime_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, secondsSinceStart_s4018);
    assume __var_17 >= 0;
    __ret_0_ := __var_17;
    return;
}
...
procedure {:public} priceAtElapsedTime_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, secondsSinceStart_s4080: int) returns (__ret_0_: int);



implementation {:ForceInline} priceAtElapsedTime_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, secondsSinceStart_s4080: int) returns (__ret_0_: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 145} {:cexpr "secondsSinceStart"} boogie_si_record_sol2Bpl_int(secondsSinceStart_s4080);
  ...
  corral_source_split_125:
    ...
    call {:si_unique_call 147} {:cexpr "msSinceStart"} boogie_si_record_sol2Bpl_int(msSinceStart_s4079);
  ...
  corral_source_split_126:
    ...
    call {:si_unique_call 148} {:cexpr "relativeAuctionTime"} boogie_si_record_sol2Bpl_int(relativeAuctionTime_s4079);
    goto corral_source_split_127;

  corral_source_split_127:
    assume decayDivisor_s4079 >= 0;
    decayDivisor_s4079 := 746571428571;
    call {:si_unique_call 149} {:cexpr "decayDivisor"} boogie_si_record_sol2Bpl_int(decayDivisor_s4079);
  ...
  corral_source_split_128:
    ...
    call {:si_unique_call 150} {:cexpr "decay"} boogie_si_record_sol2Bpl_int(decay_s4079);
  ...
  corral_source_split_129:
    ...
    call {:si_unique_call 151} {:cexpr "price"} boogie_si_record_sol2Bpl_int(price_s4079);
...
implementation {:ForceInline} withdrawAfterAuctionEnded_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int)
{
  ...
  corral_source_split_134:
    ...
    call {:si_unique_call 158} {:cexpr "valueToWithdraw"} boogie_si_record_sol2Bpl_int(valueToWithdraw_s4122);
...
implementation {:ForceInline} withdrawAfterAuctionFailed_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int)
{
  ...
  corral_source_split_140:
    ...
    call {:si_unique_call 166} {:cexpr "valueToWithdraw"} boogie_si_record_sol2Bpl_int(valueToWithdraw_s4154);
...
procedure isSenderContract_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int) returns (isContract_s4222: bool);



implementation {:ForceInline} isSenderContract_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int) returns (isContract_s4222: bool)
{
  var size_s4221: int;
  ...
  corral_source_split_154:
    assume size_s4221 >= 0;
    size_s4221 := 1;
    call {:si_unique_call 187} {:cexpr "size"} boogie_si_record_sol2Bpl_int(size_s4221);
    goto corral_source_split_155;

  corral_source_split_155:
    sender_s4221 := msgsender_MSG;
    call {:si_unique_call 188} {:cexpr "sender"} boogie_si_record_sol2Bpl_ref(sender_s4221);
...
procedure stateIs_pre(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, state_s3582: int);



implementation {:ForceInline} stateIs_pre(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, state_s3582: int)
{
...
implementation CorralChoice_ValidatorAuction(this: Ref)
{
  ...
  anon39_Then:
    ...
    call {:si_unique_call 191} addressesToWhitelist_s508 := FreshRefGenerator();
    call {:si_unique_call 192} vc0x0x0_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s508);
    return;
  ...
  anon40_Then:
    ...
    call {:si_unique_call 193} addressesToWhitelist_s620 := FreshRefGenerator();
    call {:si_unique_call 194} vc0x0x1_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s620);
    return;
  ...
  anon41_Then:
    ...
    call {:si_unique_call 195} addressesToWhitelist_s732 := FreshRefGenerator();
    call {:si_unique_call 196} vc0x0x2_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s732);
    return;
  ...
  anon42_Then:
    ...
    call {:si_unique_call 197} addressesToWhitelist_s851 := FreshRefGenerator();
    call {:si_unique_call 198} vc0x0x3_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s851);
    return;
  ...
  anon43_Then:
    ...
    call {:si_unique_call 199} addressesToWhitelist_s964 := FreshRefGenerator();
    call {:si_unique_call 200} vc0x0x4_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s964);
    return;
  ...
  anon44_Then:
    ...
    call {:si_unique_call 201} addressesToWhitelist_s1082 := FreshRefGenerator();
    call {:si_unique_call 202} vc0x0x6_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s1082);
    return;
  ...
  anon45_Then:
    ...
    call {:si_unique_call 203} addressesToWhitelist_s1200 := FreshRefGenerator();
    call {:si_unique_call 204} vc0x0x7_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s1200);
    return;
  ...
  anon46_Then:
    ...
    call {:si_unique_call 205} addressesToWhitelist_s1312 := FreshRefGenerator();
    call {:si_unique_call 206} vc0x0x8_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s1312);
    return;
  ...
  anon47_Then:
    ...
    call {:si_unique_call 207} addressesToWhitelist_s1424 := FreshRefGenerator();
    call {:si_unique_call 208} vc0x0x9_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s1424);
    return;
  ...
  anon48_Then:
    ...
    call {:si_unique_call 209} addressesToWhitelist_s1563 := FreshRefGenerator();
    call {:si_unique_call 210} vc0x1x0_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s1563);
    return;
  ...
  anon49_Then:
    ...
    call {:si_unique_call 211} addressesToWhitelist_s1673 := FreshRefGenerator();
    call {:si_unique_call 212} vc0x1x1_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s1673);
    return;
  ...
  anon50_Then:
    ...
    call {:si_unique_call 213} addressesToWhitelist_s1783 := FreshRefGenerator();
    call {:si_unique_call 214} vc0x1x2_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s1783);
    return;
  ...
  anon51_Then:
    ...
    call {:si_unique_call 215} addressesToWhitelist_s1900 := FreshRefGenerator();
    call {:si_unique_call 216} vc0x1x3_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s1900);
    return;
  ...
  anon52_Then:
    ...
    call {:si_unique_call 217} addressesToWhitelist_s2011 := FreshRefGenerator();
    call {:si_unique_call 218} vc0x1x4_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s2011);
    return;
  ...
  anon53_Then:
    ...
    call {:si_unique_call 219} addressesToWhitelist_s2127 := FreshRefGenerator();
    call {:si_unique_call 220} vc0x1x6_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s2127);
    return;
  ...
  anon54_Then:
    ...
    call {:si_unique_call 221} addressesToWhitelist_s2243 := FreshRefGenerator();
    call {:si_unique_call 222} vc0x1x7_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s2243);
    return;
  ...
  anon55_Then:
    ...
    call {:si_unique_call 223} addressesToWhitelist_s2353 := FreshRefGenerator();
    call {:si_unique_call 224} vc0x1x8_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s2353);
    return;
  ...
  anon56_Then:
    ...
    call {:si_unique_call 225} addressesToWhitelist_s2463 := FreshRefGenerator();
    call {:si_unique_call 226} vc0x1x9_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s2463);
    return;
  ...
  anon57_Then:
    ...
    call {:si_unique_call 227} addressesToWhitelist_s2600 := FreshRefGenerator();
    call {:si_unique_call 228} vc0x2x0_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s2600);
    return;
  ...
  anon58_Then:
    ...
    call {:si_unique_call 229} addressesToWhitelist_s2708 := FreshRefGenerator();
    call {:si_unique_call 230} vc0x2x1_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s2708);
    return;
  ...
  anon59_Then:
    ...
    call {:si_unique_call 231} addressesToWhitelist_s2816 := FreshRefGenerator();
    call {:si_unique_call 232} vc0x2x2_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s2816);
    return;
  ...
  anon60_Then:
    ...
    call {:si_unique_call 233} addressesToWhitelist_s2931 := FreshRefGenerator();
    call {:si_unique_call 234} vc0x2x3_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s2931);
    return;
  ...
  anon61_Then:
    ...
    call {:si_unique_call 235} addressesToWhitelist_s3040 := FreshRefGenerator();
    call {:si_unique_call 236} vc0x2x4_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s3040);
    return;
  ...
  anon62_Then:
    ...
    call {:si_unique_call 237} addressesToWhitelist_s3154 := FreshRefGenerator();
    call {:si_unique_call 238} vc0x2x6_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s3154);
    return;
  ...
  anon63_Then:
    ...
    call {:si_unique_call 239} addressesToWhitelist_s3268 := FreshRefGenerator();
    call {:si_unique_call 240} vc0x2x7_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s3268);
    return;
  ...
  anon64_Then:
    ...
    call {:si_unique_call 241} addressesToWhitelist_s3376 := FreshRefGenerator();
    call {:si_unique_call 242} vc0x2x8_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s3376);
    return;
  ...
  anon65_Then:
    ...
    call {:si_unique_call 243} addressesToWhitelist_s3484 := FreshRefGenerator();
    call {:si_unique_call 244} vc0x2x9_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s3484);
    return;
  ...
  anon66_Then:
    ...
    call {:si_unique_call 245} bid_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG);
    return;
  ...
  anon67_Then:
    ...
    call {:si_unique_call 246} startAuction_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG);
    return;
  ...
  anon68_Then:
    ...
    call {:si_unique_call 247} depositBids_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG);
    return;
  ...
  anon69_Then:
    ...
    call {:si_unique_call 248} closeAuction_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG);
    return;
  ...
  anon70_Then:
    ...
    call {:si_unique_call 249} addressesToWhitelist_s3952 := FreshRefGenerator();
    call {:si_unique_call 250} addToWhitelist_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s3952);
    return;
  ...
  anon71_Then:
    ...
    call {:si_unique_call 251} __ret_0_currentPrice := currentPrice_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG);
    return;
  ...
  anon72_Then:
    ...
    call {:si_unique_call 252} __ret_0_priceAtElapsedTime := priceAtElapsedTime_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, secondsSinceStart_s4080);
    return;
...
implementation CorralEntry_ValidatorAuction()
{
  ...
  anon0:
    call {:si_unique_call 253} this := FreshRefGenerator();
    assume now >= 0;
    assume DType[this] == ValidatorAuction;
    call {:si_unique_call 254} ValidatorAuction_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, _startPriceInWei_s3678, _auctionDurationInDays_s3678, _minimalNumberOfParticipants_s3678, _maximalNumberOfParticipants_s3678, _depositLocker_s3678);
    goto anon2_LoopHead;
  ...
  anon2_LoopBody:
    ...
    call {:si_unique_call 255} CorralChoice_ValidatorAuction(this);
    goto anon2_LoopHead;
