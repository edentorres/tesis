...
procedure ValidatorAuction_ValidatorAuction_NoBaseCtor(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, _startPriceInWei_s623: int, _auctionDurationInDays_s623: int, _minimalNumberOfParticipants_s623: int, _maximalNumberOfParticipants_s623: int, _depositLocker_s623: Ref);
...
implementation {:ForceInline} ValidatorAuction_ValidatorAuction_NoBaseCtor(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, _startPriceInWei_s623: int, _auctionDurationInDays_s623: int, _minimalNumberOfParticipants_s623: int, _maximalNumberOfParticipants_s623: int, _depositLocker_s623: Ref)
{
  var __var_6: int;
  var __var_7: Ref;
  var __var_8: Ref;
  ...
  anon0:
    ...
    call {:si_unique_call 55} {:cexpr "_startPriceInWei"} boogie_si_record_sol2Bpl_int(_startPriceInWei_s623);
    call {:si_unique_call 56} {:cexpr "_auctionDurationInDays"} boogie_si_record_sol2Bpl_int(_auctionDurationInDays_s623);
    call {:si_unique_call 57} {:cexpr "_minimalNumberOfParticipants"} boogie_si_record_sol2Bpl_int(_minimalNumberOfParticipants_s623);
    call {:si_unique_call 58} {:cexpr "_maximalNumberOfParticipants"} boogie_si_record_sol2Bpl_int(_maximalNumberOfParticipants_s623);
    call {:si_unique_call 59} {:cexpr "_depositLocker"} boogie_si_record_sol2Bpl_ref(_depositLocker_s623);
  ...
  corral_source_split_32:
    assume _auctionDurationInDays_s623 >= 0;
    assume _auctionDurationInDays_s623 > 0;
    goto corral_source_split_33;

  corral_source_split_33:
    assume _auctionDurationInDays_s623 >= 0;
    assume _auctionDurationInDays_s623 < 100 * 365;
    goto corral_source_split_34;

  corral_source_split_34:
    assume _minimalNumberOfParticipants_s623 >= 0;
    assume _minimalNumberOfParticipants_s623 > 0;
    goto corral_source_split_35;

  corral_source_split_35:
    assume _maximalNumberOfParticipants_s623 >= 0;
    assume _maximalNumberOfParticipants_s623 > 0;
  ...
  corral_source_split_36:
    assume _minimalNumberOfParticipants_s623 >= 0;
    assume _maximalNumberOfParticipants_s623 >= 0;
    assume _minimalNumberOfParticipants_s623 <= _maximalNumberOfParticipants_s623;
    goto corral_source_split_37;

  corral_source_split_37:
    assume _startPriceInWei_s623 >= 0;
    assume _startPriceInWei_s623 < 1000000000000000019884624838656;
    goto corral_source_split_38;

  corral_source_split_38:
    assume startPrice_ValidatorAuction[this] >= 0;
    assume _startPriceInWei_s623 >= 0;
    startPrice_ValidatorAuction[this] := _startPriceInWei_s623;
  ...
  corral_source_split_39:
    ...
    assume _auctionDurationInDays_s623 >= 0;
    auctionDurationInDays_ValidatorAuction[this] := _auctionDurationInDays_s623;
  ...
  corral_source_split_40:
    assume maximalNumberOfParticipants_ValidatorAuction[this] >= 0;
    assume _maximalNumberOfParticipants_s623 >= 0;
    maximalNumberOfParticipants_ValidatorAuction[this] := _maximalNumberOfParticipants_s623;
  ...
  corral_source_split_41:
    ...
    assume _minimalNumberOfParticipants_s623 >= 0;
    minimalNumberOfParticipants_ValidatorAuction[this] := _minimalNumberOfParticipants_s623;
  ...
  corral_source_split_42:
    depositLocker_ValidatorAuction[this] := _depositLocker_s623;
...
procedure {:constructor} {:public} ValidatorAuction_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, _startPriceInWei_s623: int, _auctionDurationInDays_s623: int, _minimalNumberOfParticipants_s623: int, _maximalNumberOfParticipants_s623: int, _depositLocker_s623: Ref);
  modifies Balance, owner_Ownable, auctionDurationInDays_ValidatorAuction, startPrice_ValidatorAuction, minimalNumberOfParticipants_ValidatorAuction, maximalNumberOfParticipants_ValidatorAuction, Alloc, whitelist_ValidatorAuction, bids_ValidatorAuction, bidders_ValidatorAuction, startTime_ValidatorAuction, closeTime_ValidatorAuction, lowestSlotPrice_ValidatorAuction, depositLocker_ValidatorAuction, auctionState_ValidatorAuction;



implementation {:ForceInline} ValidatorAuction_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, _startPriceInWei_s623: int, _auctionDurationInDays_s623: int, _minimalNumberOfParticipants_s623: int, _maximalNumberOfParticipants_s623: int, _depositLocker_s623: Ref)
{
  var __var_6: int;
  var __var_7: Ref;
  var __var_8: Ref;
  ...
  anon0:
    ...
    call {:si_unique_call 71} {:cexpr "_startPriceInWei"} boogie_si_record_sol2Bpl_int(_startPriceInWei_s623);
    call {:si_unique_call 72} {:cexpr "_auctionDurationInDays"} boogie_si_record_sol2Bpl_int(_auctionDurationInDays_s623);
    call {:si_unique_call 73} {:cexpr "_minimalNumberOfParticipants"} boogie_si_record_sol2Bpl_int(_minimalNumberOfParticipants_s623);
    call {:si_unique_call 74} {:cexpr "_maximalNumberOfParticipants"} boogie_si_record_sol2Bpl_int(_maximalNumberOfParticipants_s623);
    call {:si_unique_call 75} {:cexpr "_depositLocker"} boogie_si_record_sol2Bpl_ref(_depositLocker_s623);
    ...
    call {:si_unique_call 78} ValidatorAuction_ValidatorAuction_NoBaseCtor(this, msgsender_MSG, msgvalue_MSG, _startPriceInWei_s623, _auctionDurationInDays_s623, _minimalNumberOfParticipants_s623, _maximalNumberOfParticipants_s623, _depositLocker_s623);
    return;
}
...
implementation {:ForceInline} bid_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int)
{
  ...
  corral_source_split_50:
    assume slotPrice_s754 >= 0;
    call {:si_unique_call 85} slotPrice_s754 := currentPrice_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG);
    slotPrice_s754 := slotPrice_s754;
    call {:si_unique_call 86} {:cexpr "slotPrice"} boogie_si_record_sol2Bpl_int(slotPrice_s754);
    goto corral_source_split_51;

  corral_source_split_51:
    assume msgvalue_MSG >= 0;
    assume slotPrice_s754 >= 0;
    assume msgvalue_MSG >= slotPrice_s754;
  ...
  anon4_Then:
    assume {:partition} slotPrice_s754 < lowestSlotPrice_ValidatorAuction[this];
  ...
  corral_source_split_61:
    assume lowestSlotPrice_ValidatorAuction[this] >= 0;
    assume slotPrice_s754 >= 0;
    lowestSlotPrice_ValidatorAuction[this] := slotPrice_s754;
    call {:si_unique_call 89} {:cexpr "lowestSlotPrice"} boogie_si_record_sol2Bpl_int(lowestSlotPrice_ValidatorAuction[this]);
    goto anon2;

  anon4_Else:
    assume {:partition} lowestSlotPrice_ValidatorAuction[this] <= slotPrice_s754;
    goto anon2;
...
procedure {:public} addToWhitelist_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s897: Ref);
  modifies M_Ref_bool;



implementation {:ForceInline} addToWhitelist_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s897: Ref)
{
  var i_s895: int;
  ...
  corral_source_split_92:
    assume i_s895 >= 0;
    assume Length[addressesToWhitelist_s897] >= 0;
    goto corral_source_split_93;

  corral_source_split_93:
    assume i_s895 >= 0;
    i_s895 := 0;
    call {:si_unique_call 122} {:cexpr "i"} boogie_si_record_sol2Bpl_int(i_s895);
    goto anon2_LoopHead;
  ...
  anon2_LoopBody:
    assume {:partition} i_s895 < Length[addressesToWhitelist_s897];
  ...
  corral_source_split_96:
    assume i_s895 >= 0;
    M_Ref_bool[whitelist_ValidatorAuction[this]][M_int_Ref[addressesToWhitelist_s897][i_s895]] := true;
    call {:si_unique_call 123} {:cexpr "whitelist[addressesToWhitelist[i]]"} boogie_si_record_sol2Bpl_bool(M_Ref_bool[whitelist_ValidatorAuction[this]][M_int_Ref[addressesToWhitelist_s897][i_s895]]);
  ...
  corral_source_split_98:
    assume i_s895 >= 0;
    i_s895 := i_s895 + 1;
    call {:si_unique_call 124} {:cexpr "i"} boogie_si_record_sol2Bpl_int(i_s895);
    assume i_s895 >= 0;
    goto anon2_LoopHead;

  anon2_LoopDone:
    assume {:partition} Length[addressesToWhitelist_s897] <= i_s895;
    return;
}
...
{
  var secondsSinceStart_s963: int;
  var __var_15: int;
  ...
  corral_source_split_117:
    assume secondsSinceStart_s963 >= 0;
    assume now >= 0;
    assume startTime_ValidatorAuction[this] >= 0;
    assume now - startTime_ValidatorAuction[this] >= 0;
    secondsSinceStart_s963 := now - startTime_ValidatorAuction[this];
    call {:si_unique_call 138} {:cexpr "secondsSinceStart"} boogie_si_record_sol2Bpl_int(secondsSinceStart_s963);
    goto corral_source_split_118;

  corral_source_split_118:
    assume __var_15 >= 0;
    assume secondsSinceStart_s963 >= 0;
    call {:si_unique_call 139} __var_15 := priceAtElapsedTime_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, secondsSinceStart_s963);
    assume __var_15 >= 0;
    __ret_0_ := __var_15;
    return;
}
...
procedure {:public} priceAtElapsedTime_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, secondsSinceStart_s1023: int) returns (__ret_0_: int);



implementation {:ForceInline} priceAtElapsedTime_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, secondsSinceStart_s1023: int) returns (__ret_0_: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 144} {:cexpr "secondsSinceStart"} boogie_si_record_sol2Bpl_int(secondsSinceStart_s1023);
  ...
  corral_source_split_122:
    ...
    call {:si_unique_call 146} {:cexpr "msSinceStart"} boogie_si_record_sol2Bpl_int(msSinceStart_s1022);
  ...
  corral_source_split_123:
    ...
    call {:si_unique_call 147} {:cexpr "relativeAuctionTime"} boogie_si_record_sol2Bpl_int(relativeAuctionTime_s1022);
    goto corral_source_split_124;

  corral_source_split_124:
    assume decayDivisor_s1022 >= 0;
    decayDivisor_s1022 := 746571428571;
    call {:si_unique_call 148} {:cexpr "decayDivisor"} boogie_si_record_sol2Bpl_int(decayDivisor_s1022);
  ...
  corral_source_split_125:
    ...
    assume 3 >= 0;
    assume decayDivisor_s1022 >= 0;
    assume 3 div decayDivisor_s1022 >= 0;
    decay_s1022 := 3 div decayDivisor_s1022;
    call {:si_unique_call 149} {:cexpr "decay"} boogie_si_record_sol2Bpl_int(decay_s1022);
  ...
  corral_source_split_126:
    ...
    call {:si_unique_call 150} {:cexpr "price"} boogie_si_record_sol2Bpl_int(price_s1022);
...
implementation {:ForceInline} withdrawAfterAuctionEnded_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int)
{
  ...
  corral_source_split_131:
    ...
    call {:si_unique_call 157} {:cexpr "valueToWithdraw"} boogie_si_record_sol2Bpl_int(valueToWithdraw_s1065);
...
implementation {:ForceInline} withdrawAfterAuctionFailed_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int)
{
  ...
  corral_source_split_137:
    ...
    call {:si_unique_call 165} {:cexpr "valueToWithdraw"} boogie_si_record_sol2Bpl_int(valueToWithdraw_s1097);
...
procedure isSenderContract_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int) returns (isContract_s1164: bool);



implementation {:ForceInline} isSenderContract_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int) returns (isContract_s1164: bool)
{
  var size_s1163: int;
  var sender_s1163: Ref;
  ...
  corral_source_split_152:
    sender_s1163 := msgsender_MSG;
    call {:si_unique_call 186} {:cexpr "sender"} boogie_si_record_sol2Bpl_ref(sender_s1163);
    goto corral_source_split_153;

  corral_source_split_153:
    assume size_s1163 >= 0;
    isContract_s1164 := size_s1163 > 0;
    return;
}
...
implementation CorralChoice_ValidatorAuction(this: Ref)
{
  ...
  var _startPriceInWei_s623: int;
  var _auctionDurationInDays_s623: int;
  var _minimalNumberOfParticipants_s623: int;
  var _maximalNumberOfParticipants_s623: int;
  var _depositLocker_s623: Ref;
  var addressesToWhitelist_s897: Ref;
  ...
  anon0:
    ...
    havoc _startPriceInWei_s623;
    havoc _auctionDurationInDays_s623;
    havoc _minimalNumberOfParticipants_s623;
    havoc _maximalNumberOfParticipants_s623;
    havoc _depositLocker_s623;
    havoc addressesToWhitelist_s897;
  ...
  anon11_Then:
    ...
    call {:si_unique_call 187} transferOwnership_Ownable(this, msgsender_MSG, msgvalue_MSG, newOwner_s43);
    return;
  ...
  anon12_Then:
    ...
    call {:si_unique_call 188} withdraw_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG);
    return;
  ...
  anon13_Then:
    ...
    call {:si_unique_call 189} addressesToWhitelist_s427 := FreshRefGenerator();
    call {:si_unique_call 190} vc0x0x0_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s427);
    return;
  ...
  anon14_Then:
    ...
    call {:si_unique_call 191} bid_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG);
    return;
  ...
  anon15_Then:
    ...
    call {:si_unique_call 192} startAuction_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG);
    return;
  ...
  anon16_Then:
    ...
    call {:si_unique_call 193} depositBids_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG);
    return;
  ...
  anon17_Then:
    ...
    call {:si_unique_call 194} closeAuction_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG);
    return;
  ...
  anon18_Then:
    ...
    call {:si_unique_call 195} addressesToWhitelist_s897 := FreshRefGenerator();
    call {:si_unique_call 196} addToWhitelist_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s897);
    return;
  ...
  anon19_Then:
    ...
    call {:si_unique_call 197} __ret_0_currentPrice := currentPrice_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG);
    return;
  ...
  anon20_Then:
    ...
    call {:si_unique_call 198} __ret_0_priceAtElapsedTime := priceAtElapsedTime_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, secondsSinceStart_s1023);
    return;
...
implementation CorralEntry_ValidatorAuction()
{
  ...
  anon0:
    call {:si_unique_call 199} this := FreshRefGenerator();
    assume now >= 0;
    assume DType[this] == ValidatorAuction;
    call {:si_unique_call 200} ValidatorAuction_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, _startPriceInWei_s623, _auctionDurationInDays_s623, _minimalNumberOfParticipants_s623, _maximalNumberOfParticipants_s623, _depositLocker_s623);
    goto anon2_LoopHead;
  ...
  anon2_LoopBody:
    ...
    call {:si_unique_call 201} CorralChoice_ValidatorAuction(this);
    goto anon2_LoopHead;
