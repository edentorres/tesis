...
function vc0x0x0(address[] memory addressesToWhitelist) payable public {
require((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true);
require((now > startTime && now <= startTime + auctionDurationInDays * 1 days && msg.value >= currentPrice() && whitelist[msg.sender] && bids[msg.sender] == 0));
require(true);
bid();
require(true);
assert(!((bidders.length < maximalNumberOfParticipants) && !(depositLocker.initialized()) && true && (bidders.length < maximalNumberOfParticipants) && true && !((auctionState == AuctionState.Ended || auctionState == AuctionState.Failed)) && true && true && true && true));}
function vc0x0x1(address[] memory addressesToWhitelist) payable public {
require((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true);
require(true);
require(true);
startAuction();
require(true);
assert(!((bidders.length < maximalNumberOfParticipants) && !(depositLocker.initialized()) && true && (bidders.length < maximalNumberOfParticipants) && true && !((auctionState == AuctionState.Ended || auctionState == AuctionState.Failed)) && true && true && true && true));}
function vc0x0x2(address[] memory addressesToWhitelist) payable public {
require((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true);
require(true);
require(true);
depositBids();
require(true);
assert(!((bidders.length < maximalNumberOfParticipants) && !(depositLocker.initialized()) && true && (bidders.length < maximalNumberOfParticipants) && true && !((auctionState == AuctionState.Ended || auctionState == AuctionState.Failed)) && true && true && true && true));}
function vc0x0x3(address[] memory addressesToWhitelist) payable public {
require((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true);
require((now > startTime + auctionDurationInDays * 1 days));
require(true);
closeAuction();
require(true);
assert(!((bidders.length < maximalNumberOfParticipants) && !(depositLocker.initialized()) && true && (bidders.length < maximalNumberOfParticipants) && true && !((auctionState == AuctionState.Ended || auctionState == AuctionState.Failed)) && true && true && true && true));}
function vc0x0x4(address[] memory addressesToWhitelist) payable public {
require((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true);
require(true);
require(true);
...
require(true);
assert(!((bidders.length < maximalNumberOfParticipants) && !(depositLocker.initialized()) && true && (bidders.length < maximalNumberOfParticipants) && true && !((auctionState == AuctionState.Ended || auctionState == AuctionState.Failed)) && true && true && true && true));}
function vc0x0x5(address[] memory addressesToWhitelist) payable public {
require((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true);
require(true);
require(true);
withdraw();
require(true);
assert(!((bidders.length < maximalNumberOfParticipants) && !(depositLocker.initialized()) && true && (bidders.length < maximalNumberOfParticipants) && true && !((auctionState == AuctionState.Ended || auctionState == AuctionState.Failed)) && true && true && true && true));}
function vc0x0x6(address[] memory addressesToWhitelist) payable public {
require((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true);
require((bids[msg.sender] > lowestSlotPrice));
require(true);
withdrawAfterAuctionEnded();
require(true);
assert(!((bidders.length < maximalNumberOfParticipants) && !(depositLocker.initialized()) && true && (bidders.length < maximalNumberOfParticipants) && true && !((auctionState == AuctionState.Ended || auctionState == AuctionState.Failed)) && true && true && true && true));}
function vc0x0x7(address[] memory addressesToWhitelist) payable public {
require((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true);
...
require(true);
assert(!((bidders.length < maximalNumberOfParticipants) && !(depositLocker.initialized()) && true && (bidders.length < maximalNumberOfParticipants) && true && !((auctionState == AuctionState.Ended || auctionState == AuctionState.Failed)) && true && true && true && true));}
function vc0x0x8(address[] memory addressesToWhitelist) payable public {
require((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true);
require(true);
require(true);
...
require(true);
assert(!((bidders.length < maximalNumberOfParticipants) && !(depositLocker.initialized()) && true && (bidders.length < maximalNumberOfParticipants) && true && !((auctionState == AuctionState.Ended || auctionState == AuctionState.Failed)) && true && true && true && true));}
function vc0x0x9(address[] memory addressesToWhitelist) payable public {
require((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true);
require(true);
require(true);
...
require(true);
assert(!((bidders.length < maximalNumberOfParticipants) && !(depositLocker.initialized()) && true && (bidders.length < maximalNumberOfParticipants) && true && !((auctionState == AuctionState.Ended || auctionState == AuctionState.Failed)) && true && true && true && true));}
function vc0x1x0(address[] memory addressesToWhitelist) payable public {
require((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true);
require((now > startTime && now <= startTime + auctionDurationInDays * 1 days && msg.value >= currentPrice() && whitelist[msg.sender] && bids[msg.sender] == 0));
require(true);
bid();
require(true);
assert(!((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && !((auctionState == AuctionState.Ended || auctionState == AuctionState.Failed)) && true && true && true && true));}
function vc0x1x1(address[] memory addressesToWhitelist) payable public {
require((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true);
require(true);
require(true);
startAuction();
require(true);
assert(!((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && !((auctionState == AuctionState.Ended || auctionState == AuctionState.Failed)) && true && true && true && true));}
function vc0x1x2(address[] memory addressesToWhitelist) payable public {
require((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true);
require(true);
require(true);
depositBids();
require(true);
assert(!((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && !((auctionState == AuctionState.Ended || auctionState == AuctionState.Failed)) && true && true && true && true));}
function vc0x1x3(address[] memory addressesToWhitelist) payable public {
require((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true);
require((now > startTime + auctionDurationInDays * 1 days));
require(true);
closeAuction();
require(true);
assert(!((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && !((auctionState == AuctionState.Ended || auctionState == AuctionState.Failed)) && true && true && true && true));}
function vc0x1x4(address[] memory addressesToWhitelist) payable public {
require((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true);
require(true);
require(true);
addToWhitelist(addressesToWhitelist);
require(true);
assert(!((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && !((auctionState == AuctionState.Ended || auctionState == AuctionState.Failed)) && true && true && true && true));}
function vc0x1x5(address[] memory addressesToWhitelist) payable public {
require((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true);
require(true);
require(true);
withdraw();
require(true);
assert(!((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && !((auctionState == AuctionState.Ended || auctionState == AuctionState.Failed)) && true && true && true && true));}
function vc0x1x6(address[] memory addressesToWhitelist) payable public {
require((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true);
require((bids[msg.sender] > lowestSlotPrice));
require(true);
withdrawAfterAuctionEnded();
require(true);
assert(!((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && !((auctionState == AuctionState.Ended || auctionState == AuctionState.Failed)) && true && true && true && true));}
function vc0x1x7(address[] memory addressesToWhitelist) payable public {
require((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true);
require((bids[msg.sender] > 0));
require(true);
withdrawAfterAuctionFailed();
require(true);
assert(!((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && !((auctionState == AuctionState.Ended || auctionState == AuctionState.Failed)) && true && true && true && true));}
function vc0x1x8(address[] memory addressesToWhitelist) payable public {
require((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true);
require(true);
require(true);
transitionToDepositPending();
require(true);
assert(!((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && !((auctionState == AuctionState.Ended || auctionState == AuctionState.Failed)) && true && true && true && true));}
function vc0x1x9(address[] memory addressesToWhitelist) payable public {
require((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true);
require(true);
require(true);
transitionToAuctionFailed();
require(true);
assert(!((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && !((auctionState == AuctionState.Ended || auctionState == AuctionState.Failed)) && true && true && true && true));}
function vc0x2x0(address[] memory addressesToWhitelist) payable public {
require((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true);
require((now > startTime && now <= startTime + auctionDurationInDays * 1 days && msg.value >= currentPrice() && whitelist[msg.sender] && bids[msg.sender] == 0));
require(true);
bid();
require(true);
assert(!((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true));}
function vc0x2x1(address[] memory addressesToWhitelist) payable public {
require((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true);
require(true);
require(true);
startAuction();
require(true);
assert(!((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true));}
function vc0x2x2(address[] memory addressesToWhitelist) payable public {
require((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true);
require(true);
require(true);
depositBids();
require(true);
assert(!((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true));}
function vc0x2x3(address[] memory addressesToWhitelist) payable public {
require((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true);
require((now > startTime + auctionDurationInDays * 1 days));
require(true);
closeAuction();
require(true);
assert(!((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true));}
function vc0x2x4(address[] memory addressesToWhitelist) payable public {
require((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true);
require(true);
require(true);
addToWhitelist(addressesToWhitelist);
require(true);
assert(!((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true));}
function vc0x2x5(address[] memory addressesToWhitelist) payable public {
require((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true);
require(true);
require(true);
withdraw();
require(true);
assert(!((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true));}
function vc0x2x6(address[] memory addressesToWhitelist) payable public {
require((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true);
require((bids[msg.sender] > lowestSlotPrice));
require(true);
withdrawAfterAuctionEnded();
require(true);
assert(!((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true));}
function vc0x2x7(address[] memory addressesToWhitelist) payable public {
require((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true);
require((bids[msg.sender] > 0));
require(true);
withdrawAfterAuctionFailed();
require(true);
assert(!((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true));}
function vc0x2x8(address[] memory addressesToWhitelist) payable public {
require((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true);
require(true);
require(true);
transitionToDepositPending();
require(true);
assert(!((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true));}
function vc0x2x9(address[] memory addressesToWhitelist) payable public {
require((bidders.length < maximalNumberOfParticipants) && depositLocker.initialized() && true && (bidders.length < maximalNumberOfParticipants) && true && (auctionState == AuctionState.Ended || auctionState == AuctionState.Failed) && true && true && true && true);
require(true);
require(true);
transitionToAuctionFailed();
