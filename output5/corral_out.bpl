...
procedure {:public} vc0x0x0_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s425: Ref);
  modifies Balance;



implementation {:ForceInline} vc0x0x0_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s425: Ref)
{
  var __var_4: bool;
  var __var_5: int;
...
procedure ValidatorAuction_ValidatorAuction_NoBaseCtor(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, _startPriceInWei_s619: int, _auctionDurationInDays_s619: int, _minimalNumberOfParticipants_s619: int, _maximalNumberOfParticipants_s619: int, _depositLocker_s619: Ref);
...
implementation {:ForceInline} ValidatorAuction_ValidatorAuction_NoBaseCtor(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, _startPriceInWei_s619: int, _auctionDurationInDays_s619: int, _minimalNumberOfParticipants_s619: int, _maximalNumberOfParticipants_s619: int, _depositLocker_s619: Ref)
{
  var __var_6: int;
  var __var_7: Ref;
  var __var_8: Ref;
  ...
  anon0:
    ...
    call {:si_unique_call 55} {:cexpr "_startPriceInWei"} boogie_si_record_sol2Bpl_int(_startPriceInWei_s619);
    call {:si_unique_call 56} {:cexpr "_auctionDurationInDays"} boogie_si_record_sol2Bpl_int(_auctionDurationInDays_s619);
    call {:si_unique_call 57} {:cexpr "_minimalNumberOfParticipants"} boogie_si_record_sol2Bpl_int(_minimalNumberOfParticipants_s619);
    call {:si_unique_call 58} {:cexpr "_maximalNumberOfParticipants"} boogie_si_record_sol2Bpl_int(_maximalNumberOfParticipants_s619);
    call {:si_unique_call 59} {:cexpr "_depositLocker"} boogie_si_record_sol2Bpl_ref(_depositLocker_s619);
...
procedure {:constructor} {:public} ValidatorAuction_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, _startPriceInWei_s619: int, _auctionDurationInDays_s619: int, _minimalNumberOfParticipants_s619: int, _maximalNumberOfParticipants_s619: int, _depositLocker_s619: Ref);
  modifies Balance, owner_Ownable, auctionDurationInDays_ValidatorAuction, startPrice_ValidatorAuction, minimalNumberOfParticipants_ValidatorAuction, maximalNumberOfParticipants_ValidatorAuction, Alloc, whitelist_ValidatorAuction, bids_ValidatorAuction, bidders_ValidatorAuction, startTime_ValidatorAuction, closeTime_ValidatorAuction, lowestSlotPrice_ValidatorAuction, depositLocker_ValidatorAuction, auctionState_ValidatorAuction;



implementation {:ForceInline} ValidatorAuction_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, _startPriceInWei_s619: int, _auctionDurationInDays_s619: int, _minimalNumberOfParticipants_s619: int, _maximalNumberOfParticipants_s619: int, _depositLocker_s619: Ref)
{
  var __var_6: int;
  var __var_7: Ref;
  var __var_8: Ref;
  ...
  anon0:
    ...
    call {:si_unique_call 71} {:cexpr "_startPriceInWei"} boogie_si_record_sol2Bpl_int(_startPriceInWei_s619);
    call {:si_unique_call 72} {:cexpr "_auctionDurationInDays"} boogie_si_record_sol2Bpl_int(_auctionDurationInDays_s619);
    call {:si_unique_call 73} {:cexpr "_minimalNumberOfParticipants"} boogie_si_record_sol2Bpl_int(_minimalNumberOfParticipants_s619);
    call {:si_unique_call 74} {:cexpr "_maximalNumberOfParticipants"} boogie_si_record_sol2Bpl_int(_maximalNumberOfParticipants_s619);
    call {:si_unique_call 75} {:cexpr "_depositLocker"} boogie_si_record_sol2Bpl_ref(_depositLocker_s619);
    ...
    call {:si_unique_call 78} ValidatorAuction_ValidatorAuction_NoBaseCtor(this, msgsender_MSG, msgvalue_MSG, _startPriceInWei_s619, _auctionDurationInDays_s619, _minimalNumberOfParticipants_s619, _maximalNumberOfParticipants_s619, _depositLocker_s619);
    return;
}
...
implementation {:ForceInline} bid_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int)
{
  ...
  corral_source_split_50:
    ...
    call {:si_unique_call 85} slotPrice_s750 := currentPrice_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG);
    slotPrice_s750 := slotPrice_s750;
    call {:si_unique_call 86} {:cexpr "slotPrice"} boogie_si_record_sol2Bpl_int(slotPrice_s750);
  ...
  anon4_Then:
    assume {:partition} slotPrice_s750 < lowestSlotPrice_ValidatorAuction[this];
  ...
  anon4_Else:
    assume {:partition} lowestSlotPrice_ValidatorAuction[this] <= slotPrice_s750;
    goto anon2;
...
procedure {:public} addToWhitelist_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s893: Ref);
  modifies M_Ref_bool;



implementation {:ForceInline} addToWhitelist_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, addressesToWhitelist_s893: Ref)
{
  var i_s891: int;
  ...
  corral_source_split_93:
    assume i_s891 >= 0;
    i_s891 := 0;
    call {:si_unique_call 122} {:cexpr "i"} boogie_si_record_sol2Bpl_int(i_s891);
    goto anon2_LoopHead;
  ...
  anon2_LoopBody:
    assume {:partition} i_s891 < Length[addressesToWhitelist_s893];
  ...
  corral_source_split_96:
    ...
    call {:si_unique_call 123} {:cexpr "whitelist[addressesToWhitelist[i]]"} boogie_si_record_sol2Bpl_bool(M_Ref_bool[whitelist_ValidatorAuction[this]][M_int_Ref[addressesToWhitelist_s893][i_s891]]);
  ...
  corral_source_split_98:
    assume i_s891 >= 0;
    i_s891 := i_s891 + 1;
    call {:si_unique_call 124} {:cexpr "i"} boogie_si_record_sol2Bpl_int(i_s891);
    assume i_s891 >= 0;
    goto anon2_LoopHead;

  anon2_LoopDone:
    assume {:partition} Length[addressesToWhitelist_s893] <= i_s891;
    return;
}
...
implementation {:ForceInline} currentPrice_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int) returns (__ret_0_: int)
{
  ...
  corral_source_split_117:
    ...
    call {:si_unique_call 138} {:cexpr "secondsSinceStart"} boogie_si_record_sol2Bpl_int(secondsSinceStart_s959);
    goto corral_source_split_118;

  corral_source_split_118:
    assume __var_15 >= 0;
    assume secondsSinceStart_s959 >= 0;
    call {:si_unique_call 139} __var_15 := priceAtElapsedTime_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, secondsSinceStart_s959);
    assume __var_15 >= 0;
    __ret_0_ := __var_15;
    return;
}
...
procedure {:public} priceAtElapsedTime_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, secondsSinceStart_s1021: int) returns (__ret_0_: int);



implementation {:ForceInline} priceAtElapsedTime_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, secondsSinceStart_s1021: int) returns (__ret_0_: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 144} {:cexpr "secondsSinceStart"} boogie_si_record_sol2Bpl_int(secondsSinceStart_s1021);
  ...
  corral_source_split_122:
    ...
    call {:si_unique_call 146} {:cexpr "msSinceStart"} boogie_si_record_sol2Bpl_int(msSinceStart_s1020);
  ...
  corral_source_split_123:
    ...
    call {:si_unique_call 147} {:cexpr "relativeAuctionTime"} boogie_si_record_sol2Bpl_int(relativeAuctionTime_s1020);
    goto corral_source_split_124;

  corral_source_split_124:
    assume decayDivisor_s1020 >= 0;
    decayDivisor_s1020 := 746571428571;
    call {:si_unique_call 148} {:cexpr "decayDivisor"} boogie_si_record_sol2Bpl_int(decayDivisor_s1020);
  ...
  corral_source_split_125:
    ...
    call {:si_unique_call 149} {:cexpr "decay"} boogie_si_record_sol2Bpl_int(decay_s1020);
  ...
  corral_source_split_126:
    ...
    call {:si_unique_call 150} {:cexpr "price"} boogie_si_record_sol2Bpl_int(price_s1020);
...
implementation {:ForceInline} withdrawAfterAuctionEnded_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int)
{
  ...
  corral_source_split_131:
    ...
    call {:si_unique_call 157} {:cexpr "valueToWithdraw"} boogie_si_record_sol2Bpl_int(valueToWithdraw_s1063);
...
implementation {:ForceInline} withdrawAfterAuctionFailed_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int)
{
  ...
  corral_source_split_137:
    ...
    call {:si_unique_call 165} {:cexpr "valueToWithdraw"} boogie_si_record_sol2Bpl_int(valueToWithdraw_s1095);
...
procedure isSenderContract_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int) returns (isContract_s1163: bool);



implementation {:ForceInline} isSenderContract_ValidatorAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int) returns (isContract_s1163: bool)
{
  var size_s1162: int;
  ...
  corral_source_split_151:
    assume size_s1162 >= 0;
    size_s1162 := 1;
    call {:si_unique_call 186} {:cexpr "size"} boogie_si_record_sol2Bpl_int(size_s1162);
    goto corral_source_split_152;

  corral_source_split_152:
    sender_s1162 := msgsender_MSG;
    call {:si_unique_call 187} {:cexpr "sender"} boogie_si_record_sol2Bpl_ref(sender_s1162);
...
procedure stateIs_pre(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, state_s523: int);



implementation {:ForceInline} stateIs_pre(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, state_s523: int)
{
...
implementation CorralChoice_ValidatorAuction(this: Ref)
{
  ...
  anon13_Then:
    ...
    call {:si_unique_call 190} addressesToWhitelist_s425 := FreshRefGenerator();
    call {:si_unique_call 191} vc0x0x0_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s425);
    return;
  ...
  anon18_Then:
    ...
    call {:si_unique_call 196} addressesToWhitelist_s893 := FreshRefGenerator();
    call {:si_unique_call 197} addToWhitelist_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, addressesToWhitelist_s893);
    return;
  ...
  anon20_Then:
    ...
    call {:si_unique_call 199} __ret_0_priceAtElapsedTime := priceAtElapsedTime_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, secondsSinceStart_s1021);
    return;
...
implementation CorralEntry_ValidatorAuction()
{
  ...
  anon0:
    ...
    call {:si_unique_call 201} ValidatorAuction_ValidatorAuction(this, msgsender_MSG, msgvalue_MSG, _startPriceInWei_s619, _auctionDurationInDays_s619, _minimalNumberOfParticipants_s619, _maximalNumberOfParticipants_s619, _depositLocker_s619);
    goto anon2_LoopHead;
