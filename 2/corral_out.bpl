...
procedure {:public} validCombinationinitx0_SimpleMarketplace(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, offerPrice_s17: int);



implementation {:ForceInline} validCombinationinitx0_SimpleMarketplace(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, offerPrice_s17: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 4} {:cexpr "offerPrice"} boogie_si_record_sol2Bpl_int(offerPrice_s17);
...
procedure SimpleMarketplace_SimpleMarketplace_NoBaseCtor(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, description_s64: int, price_s64: int, sender_s64: Ref);
...
implementation {:ForceInline} SimpleMarketplace_SimpleMarketplace_NoBaseCtor(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, description_s64: int, price_s64: int, sender_s64: Ref)
{
  var __var_1: Ref;
  ...
  anon0:
    ...
    call {:si_unique_call 11} {:cexpr "description"} boogie_si_record_sol2Bpl_int(description_s64);
    call {:si_unique_call 12} {:cexpr "price"} boogie_si_record_sol2Bpl_int(price_s64);
    call {:si_unique_call 13} {:cexpr "sender"} boogie_si_record_sol2Bpl_ref(sender_s64);
...
procedure {:constructor} {:public} SimpleMarketplace_SimpleMarketplace(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, description_s64: int, price_s64: int, sender_s64: Ref);
  modifies Balance, InstanceOwner_SimpleMarketplace, Description_SimpleMarketplace, AskingPrice_SimpleMarketplace, Alloc, result_SimpleMarketplace, InstanceBuyer_SimpleMarketplace, OfferPrice_SimpleMarketplace, StateEnum_SimpleMarketplace;



implementation {:ForceInline} SimpleMarketplace_SimpleMarketplace(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, description_s64: int, price_s64: int, sender_s64: Ref)
{
  var __var_1: Ref;
  ...
  anon0:
    ...
    call {:si_unique_call 22} {:cexpr "description"} boogie_si_record_sol2Bpl_int(description_s64);
    call {:si_unique_call 23} {:cexpr "price"} boogie_si_record_sol2Bpl_int(price_s64);
    call {:si_unique_call 24} {:cexpr "sender"} boogie_si_record_sol2Bpl_ref(sender_s64);
    call {:si_unique_call 25} {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
    call {:si_unique_call 26} SimpleMarketplace_SimpleMarketplace_NoBaseCtor(this, msgsender_MSG, msgvalue_MSG, description_s64, price_s64, sender_s64);
    return;
}



procedure {:public} MakeOffer_SimpleMarketplace(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, offerPrice_s110: int);
  modifies InstanceBuyer_SimpleMarketplace, OfferPrice_SimpleMarketplace, StateEnum_SimpleMarketplace;



implementation {:ForceInline} MakeOffer_SimpleMarketplace(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, offerPrice_s110: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 31} {:cexpr "offerPrice"} boogie_si_record_sol2Bpl_int(offerPrice_s110);
  ...
  anon7_Then:
    assume {:partition} offerPrice_s110 == 0;
...
implementation CorralChoice_SimpleMarketplace(this: Ref)
{
  ...
  anon5_Then:
    ...
    call {:si_unique_call 45} validCombinationinitx0_SimpleMarketplace(this, msgsender_MSG, msgvalue_MSG, offerPrice_s17);
    return;
  ...
  anon6_Then:
    ...
    call {:si_unique_call 46} MakeOffer_SimpleMarketplace(this, msgsender_MSG, msgvalue_MSG, offerPrice_s110);
    return;
...
implementation CorralEntry_SimpleMarketplace()
{
  ...
  anon0:
    ...
    call {:si_unique_call 50} SimpleMarketplace_SimpleMarketplace(this, msgsender_MSG, msgvalue_MSG, description_s64, price_s64, sender_s64);
    goto anon2_LoopHead;
