...
implementation {:ForceInline} validCombination0x0x1_SimpleMarketplace(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, offerPrice_s62: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 4} {:cexpr "offerPrice"} boogie_si_record_sol2Bpl_int(offerPrice_s62);
  ...
  corral_source_split_4:
    call {:si_unique_call 6} AcceptOffer_SimpleMarketplace(this, msgsender_MSG, msgvalue_MSG);
...
implementation {:ForceInline} SimpleMarketplace_SimpleMarketplace_NoBaseCtor(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, description_s397: int, price_s397: int, sender_s397: Ref)
{
  ...
  anon0:
    ...
    Description_SimpleMarketplace[this] := -1326172911;
