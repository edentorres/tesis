...
function validCombinationinitx0(int humidity, int temperature, int timestamp, address newCounterparty) public {
//Remplazar acá
...
function validCombinationinitx1(int humidity, int temperature, int timestamp, address newCounterparty) public {
//Remplazar acá
assert(!(State != StateType.Completed && State != StateType.OutOfCompliance  && State != StateType.Completed && State != StateType.OutOfCompliance && State != StateType.Completed && State != StateType.OutOfCompliance));
}
