...
procedure {:public} {:inline 1} vc0_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s25: Ref);
implementation vc0_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s25: Ref)
{
...
call  {:cexpr "newCounterparty"} boogie_si_record_sol2Bpl_ref(newCounterparty_s25);
call  {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder10/CombinationsTemp10.sol"} {:sourceLine 4} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder10/CombinationsTemp10.sol"} {:sourceLine 6} (true);
assume ((!(((State_BasicProvenance[this]) != (2)))) && ((State_BasicProvenance[this]) != (2)));
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder10/CombinationsTemp10.sol"} {:sourceLine 7} (true);
assert (false);
}
...
procedure {:inline 1} BasicProvenance_BasicProvenance_NoBaseCtor(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, supplyChainOwner_s71: Ref, supplyChainObserver_s71: Ref);
implementation BasicProvenance_BasicProvenance_NoBaseCtor(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, supplyChainOwner_s71: Ref, supplyChainObserver_s71: Ref)
{
...
call  {:cexpr "msg.sender"} boogie_si_record_sol2Bpl_ref(msgsender_MSG);
call  {:cexpr "msg.value"} boogie_si_record_sol2Bpl_int(msgvalue_MSG);
call  {:cexpr "supplyChainOwner"} boogie_si_record_sol2Bpl_ref(supplyChainOwner_s71);
call  {:cexpr "supplyChainObserver"} boogie_si_record_sol2Bpl_ref(supplyChainObserver_s71);
call  {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder10/CombinationsTemp10.sol"} {:sourceLine 23} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder10/CombinationsTemp10.sol"} {:sourceLine 24} (true);
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder10/CombinationsTemp10.sol"} {:sourceLine 25} (true);
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder10/CombinationsTemp10.sol"} {:sourceLine 26} (true);
SupplyChainOwner_BasicProvenance[this] := supplyChainOwner_s71;
call  {:cexpr "SupplyChainOwner"} boogie_si_record_sol2Bpl_ref(SupplyChainOwner_BasicProvenance[this]);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder10/CombinationsTemp10.sol"} {:sourceLine 27} (true);
SupplyChainObserver_BasicProvenance[this] := supplyChainObserver_s71;
call  {:cexpr "SupplyChainObserver"} boogie_si_record_sol2Bpl_ref(SupplyChainObserver_BasicProvenance[this]);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder10/CombinationsTemp10.sol"} {:sourceLine 28} (true);
State_BasicProvenance[this] := 0;
}

procedure {:constructor} {:public} {:inline 1} BasicProvenance_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, supplyChainOwner_s71: Ref, supplyChainObserver_s71: Ref);
implementation BasicProvenance_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, supplyChainOwner_s71: Ref, supplyChainObserver_s71: Ref)
{
call  {:cexpr "_verisolFirstArg"} boogie_si_record_sol2Bpl_bool(false);
call  {:cexpr "this"} boogie_si_record_sol2Bpl_ref(this);
call  {:cexpr "msg.sender"} boogie_si_record_sol2Bpl_ref(msgsender_MSG);
...
call  {:cexpr "supplyChainObserver"} boogie_si_record_sol2Bpl_ref(supplyChainObserver_s71);
call  {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
call BasicProvenance_BasicProvenance_NoBaseCtor(this, msgsender_MSG, msgvalue_MSG, supplyChainOwner_s71, supplyChainObserver_s71);
}

procedure {:public} {:inline 1} TransferResponsibility_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s110: Ref);
implementation TransferResponsibility_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s110: Ref)
{
call  {:cexpr "_verisolFirstArg"} boogie_si_record_sol2Bpl_bool(false);
call  {:cexpr "this"} boogie_si_record_sol2Bpl_ref(this);
call  {:cexpr "msg.sender"} boogie_si_record_sol2Bpl_ref(msgsender_MSG);
call  {:cexpr "msg.value"} boogie_si_record_sol2Bpl_int(msgvalue_MSG);
call  {:cexpr "newCounterparty"} boogie_si_record_sol2Bpl_ref(newCounterparty_s110);
call  {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder10/CombinationsTemp10.sol"} {:sourceLine 32} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder10/CombinationsTemp10.sol"} {:sourceLine 33} (true);
if (((Counterparty_BasicProvenance[this]) != (msgsender_MSG)) || ((State_BasicProvenance[this]) == (2))) {
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder10/CombinationsTemp10.sol"} {:sourceLine 34} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder10/CombinationsTemp10.sol"} {:sourceLine 35} (true);
assume (false);
}
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder10/CombinationsTemp10.sol"} {:sourceLine 38} (true);
if ((State_BasicProvenance[this]) == (0)) {
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder10/CombinationsTemp10.sol"} {:sourceLine 39} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder10/CombinationsTemp10.sol"} {:sourceLine 40} (true);
State_BasicProvenance[this] := 1;
}
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder10/CombinationsTemp10.sol"} {:sourceLine 43} (true);
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder10/CombinationsTemp10.sol"} {:sourceLine 44} (true);
Counterparty_BasicProvenance[this] := newCounterparty_s110;
call  {:cexpr "Counterparty"} boogie_si_record_sol2Bpl_ref(Counterparty_BasicProvenance[this]);
}
...
call  {:cexpr "msg.value"} boogie_si_record_sol2Bpl_int(msgvalue_MSG);
call  {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder10/CombinationsTemp10.sol"} {:sourceLine 48} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder10/CombinationsTemp10.sol"} {:sourceLine 49} (true);
if (((SupplyChainOwner_BasicProvenance[this]) != (msgsender_MSG)) || ((State_BasicProvenance[this]) == (2))) {
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder10/CombinationsTemp10.sol"} {:sourceLine 50} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder10/CombinationsTemp10.sol"} {:sourceLine 51} (true);
assume (false);
}
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder10/CombinationsTemp10.sol"} {:sourceLine 54} (true);
State_BasicProvenance[this] := 2;
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder10/CombinationsTemp10.sol"} {:sourceLine 55} (true);
PreviousCounterparty_BasicProvenance[this] := Counterparty_BasicProvenance[this];
call  {:cexpr "PreviousCounterparty"} boogie_si_record_sol2Bpl_ref(PreviousCounterparty_BasicProvenance[this]);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder10/CombinationsTemp10.sol"} {:sourceLine 56} (true);
__var_1 := null;
...
var supplyChainOwner_s71: Ref;
var supplyChainObserver_s71: Ref;
var newCounterparty_s110: Ref;
var tmpNow: int;
assume ((now) >= (0));
assume ((DType[this]) == (BasicProvenance));
call BasicProvenance_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, supplyChainOwner_s71, supplyChainObserver_s71);
while (true)
...
havoc supplyChainOwner_s71;
havoc supplyChainObserver_s71;
havoc newCounterparty_s110;
havoc tmpNow;
tmpNow := now;
havoc now;
assume ((now) > (tmpNow));
...
if ((choice) == (3)) {
call vc0_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s25);
} else if ((choice) == (2)) {
call TransferResponsibility_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s110);
} else if ((choice) == (1)) {
