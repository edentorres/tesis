...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 51} (true);
assume (false);
}
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 55} (true);
PreviousCounterparty_BasicProvenance[this] := Counterparty_BasicProvenance[this];
call  {:cexpr "PreviousCounterparty"} boogie_si_record_sol2Bpl_ref(PreviousCounterparty_BasicProvenance[this]);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 56} (true);
__var_1 := null;
