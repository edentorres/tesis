...
procedure {:public} {:inline 1} validCombination0_RefrigeratedTransportation(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, humidity_s55: int, temperature_s55: int, timestamp_s55: int, newCounterparty_s55: Ref);
implementation validCombination0_RefrigeratedTransportation(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, humidity_s55: int, temperature_s55: int, timestamp_s55: int, newCounterparty_s55: Ref)
{
...
call  {:cexpr "humidity"} boogie_si_record_sol2Bpl_int(humidity_s55);
call  {:cexpr "temperature"} boogie_si_record_sol2Bpl_int(temperature_s55);
call  {:cexpr "timestamp"} boogie_si_record_sol2Bpl_int(timestamp_s55);
call  {:cexpr "newCounterparty"} boogie_si_record_sol2Bpl_ref(newCounterparty_s55);
...
procedure {:inline 1} RefrigeratedTransportation_RefrigeratedTransportation_NoBaseCtor(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, device_s175: Ref, supplyChainOwner_s175: Ref, supplyChainObserver_s175: Ref, minHumidity_s175: int, maxHumidity_s175: int, minTemperature_s175: int, maxTemperature_s175: int);
implementation RefrigeratedTransportation_RefrigeratedTransportation_NoBaseCtor(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, device_s175: Ref, supplyChainOwner_s175: Ref, supplyChainObserver_s175: Ref, minHumidity_s175: int, maxHumidity_s175: int, minTemperature_s175: int, maxTemperature_s175: int)
{
...
call  {:cexpr "msg.sender"} boogie_si_record_sol2Bpl_ref(msgsender_MSG);
call  {:cexpr "msg.value"} boogie_si_record_sol2Bpl_int(msgvalue_MSG);
call  {:cexpr "device"} boogie_si_record_sol2Bpl_ref(device_s175);
call  {:cexpr "supplyChainOwner"} boogie_si_record_sol2Bpl_ref(supplyChainOwner_s175);
call  {:cexpr "supplyChainObserver"} boogie_si_record_sol2Bpl_ref(supplyChainObserver_s175);
call  {:cexpr "minHumidity"} boogie_si_record_sol2Bpl_int(minHumidity_s175);
call  {:cexpr "maxHumidity"} boogie_si_record_sol2Bpl_int(maxHumidity_s175);
call  {:cexpr "minTemperature"} boogie_si_record_sol2Bpl_int(minTemperature_s175);
call  {:cexpr "maxTemperature"} boogie_si_record_sol2Bpl_int(maxTemperature_s175);
call  {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 35} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 36} (true);
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 37} (true);
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 39} (true);
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 40} (true);
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 41} (true);
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 42} (true);
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 47} (true);
...
procedure {:constructor} {:public} {:inline 1} RefrigeratedTransportation_RefrigeratedTransportation(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, device_s175: Ref, supplyChainOwner_s175: Ref, supplyChainObserver_s175: Ref, minHumidity_s175: int, maxHumidity_s175: int, minTemperature_s175: int, maxTemperature_s175: int);
implementation RefrigeratedTransportation_RefrigeratedTransportation(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, device_s175: Ref, supplyChainOwner_s175: Ref, supplyChainObserver_s175: Ref, minHumidity_s175: int, maxHumidity_s175: int, minTemperature_s175: int, maxTemperature_s175: int)
{
call  {:cexpr "_verisolFirstArg"} boogie_si_record_sol2Bpl_bool(false);
call  {:cexpr "this"} boogie_si_record_sol2Bpl_ref(this);
call  {:cexpr "msg.sender"} boogie_si_record_sol2Bpl_ref(msgsender_MSG);
...
call  {:cexpr "maxTemperature"} boogie_si_record_sol2Bpl_int(maxTemperature_s175);
call  {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
call RefrigeratedTransportation_RefrigeratedTransportation_NoBaseCtor(this, msgsender_MSG, msgvalue_MSG, device_s175, supplyChainOwner_s175, supplyChainObserver_s175, minHumidity_s175, maxHumidity_s175, minTemperature_s175, maxTemperature_s175);
}

procedure {:public} {:inline 1} IngestTelemetry_RefrigeratedTransportation(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, humidity_s278: int, temperature_s278: int, timestamp_s278: int);
implementation IngestTelemetry_RefrigeratedTransportation(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, humidity_s278: int, temperature_s278: int, timestamp_s278: int)
{
call  {:cexpr "_verisolFirstArg"} boogie_si_record_sol2Bpl_bool(false);
call  {:cexpr "this"} boogie_si_record_sol2Bpl_ref(this);
call  {:cexpr "msg.sender"} boogie_si_record_sol2Bpl_ref(msgsender_MSG);
call  {:cexpr "msg.value"} boogie_si_record_sol2Bpl_int(msgvalue_MSG);
call  {:cexpr "humidity"} boogie_si_record_sol2Bpl_int(humidity_s278);
call  {:cexpr "temperature"} boogie_si_record_sol2Bpl_int(temperature_s278);
call  {:cexpr "timestamp"} boogie_si_record_sol2Bpl_int(timestamp_s278);
call  {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 54} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 58} (true);
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 63} (true);
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 68} (true);
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 73} (true);
...
if (((humidity_s278) > (MaxHumidity_RefrigeratedTransportation[this])) || ((humidity_s278) < (MinHumidity_RefrigeratedTransportation[this]))) {
...
call  {:cexpr "ComplianceSensorReading"} boogie_si_record_sol2Bpl_int(ComplianceSensorReading_RefrigeratedTransportation[this]);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 79} (true);
ComplianceDetail_RefrigeratedTransportation[this] := 1717938572;
call  {:cexpr "ComplianceDetail"} boogie_si_record_sol2Bpl_int(ComplianceDetail_RefrigeratedTransportation[this]);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 80} (true);
ComplianceStatus_RefrigeratedTransportation[this] := false;
call  {:cexpr "ComplianceStatus"} boogie_si_record_sol2Bpl_bool(ComplianceStatus_RefrigeratedTransportation[this]);
} else {
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 82} (true);
if (((temperature_s278) > (MaxTemperature_RefrigeratedTransportation[this])) || ((temperature_s278) < (MinTemperature_RefrigeratedTransportation[this]))) {
...
call  {:cexpr "ComplianceDetail"} boogie_si_record_sol2Bpl_int(ComplianceDetail_RefrigeratedTransportation[this]);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 87} (true);
ComplianceStatus_RefrigeratedTransportation[this] := false;
call  {:cexpr "ComplianceStatus"} boogie_si_record_sol2Bpl_bool(ComplianceStatus_RefrigeratedTransportation[this]);
}
}
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 91} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 92} (true);
State_RefrigeratedTransportation[this] := 3;
}
}

procedure {:public} {:inline 1} TransferResponsibility_RefrigeratedTransportation(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s343: Ref);
implementation TransferResponsibility_RefrigeratedTransportation(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s343: Ref)
{
call  {:cexpr "_verisolFirstArg"} boogie_si_record_sol2Bpl_bool(false);
call  {:cexpr "this"} boogie_si_record_sol2Bpl_ref(this);
call  {:cexpr "msg.sender"} boogie_si_record_sol2Bpl_ref(msgsender_MSG);
call  {:cexpr "msg.value"} boogie_si_record_sol2Bpl_int(msgvalue_MSG);
call  {:cexpr "newCounterparty"} boogie_si_record_sol2Bpl_ref(newCounterparty_s343);
call  {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 99} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 102} (true);
if ((State_RefrigeratedTransportation[this]) == (2)) {
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 107} (true);
if ((State_RefrigeratedTransportation[this]) == (3)) {
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 112} (true);
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 113} (true);
...
if ((newCounterparty_s343) == (Device_RefrigeratedTransportation[this])) {
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 118} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 119} (true);
assume (false);
}
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 122} (true);
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 128} (true);
...
call  {:cexpr "msg.value"} boogie_si_record_sol2Bpl_int(msgvalue_MSG);
call  {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 133} (true);
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder0/CombinationsTemp0.sol"} {:sourceLine 143} (true);
assume (false);
}
...
call RefrigeratedTransportation_RefrigeratedTransportation(this, msgsender_MSG, msgvalue_MSG, device_s175, supplyChainOwner_s175, supplyChainObserver_s175, minHumidity_s175, maxHumidity_s175, minTemperature_s175, maxTemperature_s175);
while (true)
...
if ((choice) == (4)) {
call validCombination0_RefrigeratedTransportation(this, msgsender_MSG, msgvalue_MSG, humidity_s55, temperature_s55, timestamp_s55, newCounterparty_s55);
} else if ((choice) == (3)) {
call IngestTelemetry_RefrigeratedTransportation(this, msgsender_MSG, msgvalue_MSG, humidity_s278, temperature_s278, timestamp_s278);
} else if ((choice) == (2)) {
call TransferResponsibility_RefrigeratedTransportation(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s343);
} else if ((choice) == (1)) {
