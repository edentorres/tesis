...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 5} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 7} (true);
assume (((!(((StateEnum_SimpleMarketplace[this]) == (0)))) && ((StateEnum_SimpleMarketplace[this]) == (1))) && ((StateEnum_SimpleMarketplace[this]) == (1)));
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 8} (true);
assume ((msgsender_MSG) == (InstanceOwner_SimpleMarketplace[this]));
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 9} (true);
call Reject_SimpleMarketplace(this, msgsender_MSG, msgvalue_MSG);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 10} (true);
...
Description_SimpleMarketplace[this] := -900018679;
...
call  {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 29} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 30} (true);
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 31} (true);
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 32} (true);
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 33} (true);
...
call  {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 37} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 38} (true);
if ((offerPrice_s151) == (0)) {
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 39} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 40} (true);
assume (false);
}
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 43} (true);
if ((StateEnum_SimpleMarketplace[this]) != (0)) {
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 44} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 45} (true);
assume (false);
}
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 48} (true);
if ((InstanceOwner_SimpleMarketplace[this]) == (msgsender_MSG)) {
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 49} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 50} (true);
assume (false);
}
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 53} (true);
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 54} (true);
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 55} (true);
...
call  {:cexpr "msg.value"} boogie_si_record_sol2Bpl_int(msgvalue_MSG);
call  {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 59} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 60} (true);
if ((StateEnum_SimpleMarketplace[this]) != (1)) {
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 61} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 62} (true);
assume (false);
}
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 65} (true);
if ((InstanceOwner_SimpleMarketplace[this]) != (msgsender_MSG)) {
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 66} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 67} (true);
assume (false);
}
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 71} (true);
StateEnum_SimpleMarketplace[this] := 0;
}
...
call  {:cexpr "msg.value"} boogie_si_record_sol2Bpl_int(msgvalue_MSG);
call  {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 75} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 76} (true);
if ((StateEnum_SimpleMarketplace[this]) != (1)) {
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 77} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 78} (true);
assume (false);
}
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 81} (true);
if ((msgsender_MSG) != (InstanceOwner_SimpleMarketplace[this])) {
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 82} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 83} (true);
assume (false);
}
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/CombinationsTemp2¡.sol"} {:sourceLine 86} (true);
