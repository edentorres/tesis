...
procedure {:public} {:inline 1} vc0x0x0_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s50: Ref);
procedure {:public} {:inline 1} vc0x1x0_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s97: Ref);
procedure {:public} {:inline 1} vc0x2x0_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s144: Ref);
implementation vc0x2x0_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s144: Ref)
{
...
call  {:cexpr "newCounterparty"} boogie_si_record_sol2Bpl_ref(newCounterparty_s144);
call  {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/output1/OutputTemp1.sol"} {:sourceLine 14} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/output1/OutputTemp1.sol"} {:sourceLine 15} (true);
assume (((State_BasicProvenance[this]) == (0)) && (!(((State_BasicProvenance[this]) == (1)))));
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/output1/OutputTemp1.sol"} {:sourceLine 16} (true);
assume ((Counterparty_BasicProvenance[this]) == (msgsender_MSG));
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/output1/OutputTemp1.sol"} {:sourceLine 17} (true);
call TransferResponsibility_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s144);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/output1/OutputTemp1.sol"} {:sourceLine 18} (true);
assert (!(((!(((State_BasicProvenance[this]) == (0)))) && ((State_BasicProvenance[this]) == (1)))));
}
...
procedure {:inline 1} BasicProvenance_BasicProvenance_NoBaseCtor(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, supplyChainOwner_s190: Ref, supplyChainObserver_s190: Ref);
implementation BasicProvenance_BasicProvenance_NoBaseCtor(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, supplyChainOwner_s190: Ref, supplyChainObserver_s190: Ref)
{
...
call  {:cexpr "msg.sender"} boogie_si_record_sol2Bpl_ref(msgsender_MSG);
call  {:cexpr "msg.value"} boogie_si_record_sol2Bpl_int(msgvalue_MSG);
call  {:cexpr "supplyChainOwner"} boogie_si_record_sol2Bpl_ref(supplyChainOwner_s190);
call  {:cexpr "supplyChainObserver"} boogie_si_record_sol2Bpl_ref(supplyChainObserver_s190);
call  {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/output1/OutputTemp1.sol"} {:sourceLine 32} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/output1/OutputTemp1.sol"} {:sourceLine 33} (true);
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/output1/OutputTemp1.sol"} {:sourceLine 34} (true);
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/output1/OutputTemp1.sol"} {:sourceLine 35} (true);
SupplyChainOwner_BasicProvenance[this] := supplyChainOwner_s190;
call  {:cexpr "SupplyChainOwner"} boogie_si_record_sol2Bpl_ref(SupplyChainOwner_BasicProvenance[this]);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/output1/OutputTemp1.sol"} {:sourceLine 36} (true);
SupplyChainObserver_BasicProvenance[this] := supplyChainObserver_s190;
call  {:cexpr "SupplyChainObserver"} boogie_si_record_sol2Bpl_ref(SupplyChainObserver_BasicProvenance[this]);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/output1/OutputTemp1.sol"} {:sourceLine 37} (true);
State_BasicProvenance[this] := 0;
}

procedure {:constructor} {:public} {:inline 1} BasicProvenance_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, supplyChainOwner_s190: Ref, supplyChainObserver_s190: Ref);
implementation BasicProvenance_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, supplyChainOwner_s190: Ref, supplyChainObserver_s190: Ref)
{
call  {:cexpr "_verisolFirstArg"} boogie_si_record_sol2Bpl_bool(false);
call  {:cexpr "this"} boogie_si_record_sol2Bpl_ref(this);
call  {:cexpr "msg.sender"} boogie_si_record_sol2Bpl_ref(msgsender_MSG);
...
call  {:cexpr "supplyChainObserver"} boogie_si_record_sol2Bpl_ref(supplyChainObserver_s190);
call  {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
call BasicProvenance_BasicProvenance_NoBaseCtor(this, msgsender_MSG, msgvalue_MSG, supplyChainOwner_s190, supplyChainObserver_s190);
}

procedure {:public} {:inline 1} TransferResponsibility_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s229: Ref);
implementation TransferResponsibility_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s229: Ref)
{
call  {:cexpr "_verisolFirstArg"} boogie_si_record_sol2Bpl_bool(false);
call  {:cexpr "this"} boogie_si_record_sol2Bpl_ref(this);
call  {:cexpr "msg.sender"} boogie_si_record_sol2Bpl_ref(msgsender_MSG);
call  {:cexpr "msg.value"} boogie_si_record_sol2Bpl_int(msgvalue_MSG);
call  {:cexpr "newCounterparty"} boogie_si_record_sol2Bpl_ref(newCounterparty_s229);
call  {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/output1/OutputTemp1.sol"} {:sourceLine 41} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/output1/OutputTemp1.sol"} {:sourceLine 42} (true);
if (((Counterparty_BasicProvenance[this]) != (msgsender_MSG)) || ((State_BasicProvenance[this]) == (2))) {
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/output1/OutputTemp1.sol"} {:sourceLine 43} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/output1/OutputTemp1.sol"} {:sourceLine 44} (true);
assume (false);
}
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/output1/OutputTemp1.sol"} {:sourceLine 47} (true);
if ((State_BasicProvenance[this]) == (0)) {
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/output1/OutputTemp1.sol"} {:sourceLine 48} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/output1/OutputTemp1.sol"} {:sourceLine 49} (true);
State_BasicProvenance[this] := 1;
}
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/output1/OutputTemp1.sol"} {:sourceLine 52} (true);
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/output1/OutputTemp1.sol"} {:sourceLine 53} (true);
Counterparty_BasicProvenance[this] := newCounterparty_s229;
call  {:cexpr "Counterparty"} boogie_si_record_sol2Bpl_ref(Counterparty_BasicProvenance[this]);
}
...
call  {:cexpr "msg.value"} boogie_si_record_sol2Bpl_int(msgvalue_MSG);
call  {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/output1/OutputTemp1.sol"} {:sourceLine 57} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/output1/OutputTemp1.sol"} {:sourceLine 58} (true);
if (((SupplyChainOwner_BasicProvenance[this]) != (msgsender_MSG)) || ((State_BasicProvenance[this]) == (2))) {
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/output1/OutputTemp1.sol"} {:sourceLine 59} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/output1/OutputTemp1.sol"} {:sourceLine 60} (true);
assume (false);
}
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/output1/OutputTemp1.sol"} {:sourceLine 63} (true);
State_BasicProvenance[this] := 2;
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/output1/OutputTemp1.sol"} {:sourceLine 64} (true);
PreviousCounterparty_BasicProvenance[this] := Counterparty_BasicProvenance[this];
call  {:cexpr "PreviousCounterparty"} boogie_si_record_sol2Bpl_ref(PreviousCounterparty_BasicProvenance[this]);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/output1/OutputTemp1.sol"} {:sourceLine 65} (true);
__var_1 := null;
...
var choice: int;
var newCounterparty_s50: Ref;
var newCounterparty_s97: Ref;
var newCounterparty_s144: Ref;
var supplyChainOwner_s190: Ref;
var supplyChainObserver_s190: Ref;
var newCounterparty_s229: Ref;
var tmpNow: int;
assume ((now) >= (0));
assume ((DType[this]) == (BasicProvenance));
call BasicProvenance_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, supplyChainOwner_s190, supplyChainObserver_s190);
while (true)
...
havoc msgvalue_MSG;
havoc choice;
havoc newCounterparty_s50;
havoc newCounterparty_s97;
havoc newCounterparty_s144;
havoc supplyChainOwner_s190;
havoc supplyChainObserver_s190;
havoc newCounterparty_s229;
havoc tmpNow;
tmpNow := now;
havoc now;
assume ((now) > (tmpNow));
...
if ((choice) == (5)) {
call vc0x0x0_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s50);
} else if ((choice) == (4)) {
call vc0x1x0_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s97);
} else if ((choice) == (3)) {
call vc0x2x0_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s144);
} else if ((choice) == (2)) {
call TransferResponsibility_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s229);
} else if ((choice) == (1)) {
