...
procedure {:public} vc0x0x0_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s50: Ref);



procedure {:public} vc0x1x0_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s97: Ref);



procedure {:public} vc0x2x0_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s144: Ref);
  modifies State_BasicProvenance, PreviousCounterparty_BasicProvenance, Counterparty_BasicProvenance;



implementation {:ForceInline} vc0x2x0_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s144: Ref)
{
  ...
  anon0:
    ...
    call {:si_unique_call 4} {:cexpr "newCounterparty"} boogie_si_record_sol2Bpl_ref(newCounterparty_s144);
  ...
  corral_source_split_4:
    call {:si_unique_call 6} TransferResponsibility_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s144);
...
procedure BasicProvenance_BasicProvenance_NoBaseCtor(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, supplyChainOwner_s190: Ref, supplyChainObserver_s190: Ref);
...
implementation {:ForceInline} BasicProvenance_BasicProvenance_NoBaseCtor(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, supplyChainOwner_s190: Ref, supplyChainObserver_s190: Ref)
{
  ...
  anon0:
    ...
    call {:si_unique_call 11} {:cexpr "supplyChainOwner"} boogie_si_record_sol2Bpl_ref(supplyChainOwner_s190);
    call {:si_unique_call 12} {:cexpr "supplyChainObserver"} boogie_si_record_sol2Bpl_ref(supplyChainObserver_s190);
...
procedure {:constructor} {:public} BasicProvenance_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, supplyChainOwner_s190: Ref, supplyChainObserver_s190: Ref);
  modifies Balance, InitiatingCounterparty_BasicProvenance, Counterparty_BasicProvenance, PreviousCounterparty_BasicProvenance, SupplyChainOwner_BasicProvenance, SupplyChainObserver_BasicProvenance, State_BasicProvenance;



implementation {:ForceInline} BasicProvenance_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, supplyChainOwner_s190: Ref, supplyChainObserver_s190: Ref)
{
  ...
  anon0:
    ...
    call {:si_unique_call 22} {:cexpr "supplyChainOwner"} boogie_si_record_sol2Bpl_ref(supplyChainOwner_s190);
    call {:si_unique_call 23} {:cexpr "supplyChainObserver"} boogie_si_record_sol2Bpl_ref(supplyChainObserver_s190);
    call {:si_unique_call 24} {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
    call {:si_unique_call 25} BasicProvenance_BasicProvenance_NoBaseCtor(this, msgsender_MSG, msgvalue_MSG, supplyChainOwner_s190, supplyChainObserver_s190);
    return;
}



procedure {:public} TransferResponsibility_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s229: Ref);
  modifies State_BasicProvenance, PreviousCounterparty_BasicProvenance, Counterparty_BasicProvenance;



implementation {:ForceInline} TransferResponsibility_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s229: Ref)
{
  ...
  anon0:
    ...
    call {:si_unique_call 30} {:cexpr "newCounterparty"} boogie_si_record_sol2Bpl_ref(newCounterparty_s229);
...
implementation CorralChoice_BasicProvenance(this: Ref)
{
  ...
  anon6_Then:
    ...
    call {:si_unique_call 41} vc0x0x0_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s50);
    return;
  ...
  anon7_Then:
    ...
    call {:si_unique_call 42} vc0x1x0_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s97);
    return;
  ...
  anon8_Then:
    ...
    call {:si_unique_call 43} vc0x2x0_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s144);
    return;
  ...
  anon9_Then:
    ...
    call {:si_unique_call 44} TransferResponsibility_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s229);
    return;
  ...
  anon10_Then:
    ...
    call {:si_unique_call 45} Complete_BasicProvenance(this, msgsender_MSG, msgvalue_MSG);
    return;
...
implementation CorralEntry_BasicProvenance()
{
  ...
  anon0:
    ...
    call {:si_unique_call 47} BasicProvenance_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, supplyChainOwner_s190, supplyChainObserver_s190);
    goto anon2_LoopHead;
  ...
  anon2_LoopBody:
    ...
    call {:si_unique_call 48} CorralChoice_BasicProvenance(this);
    goto anon2_LoopHead;
