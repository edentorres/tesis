...
procedure {:public} validCombination0_RefrigeratedTransportation(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, humidity_s49: int, temperature_s49: int, timestamp_s49: int, newCounterparty_s49: Ref);



implementation {:ForceInline} validCombination0_RefrigeratedTransportation(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, humidity_s49: int, temperature_s49: int, timestamp_s49: int, newCounterparty_s49: Ref)
{
  ...
  anon0:
    ...
    call {:si_unique_call 4} {:cexpr "humidity"} boogie_si_record_sol2Bpl_int(humidity_s49);
    call {:si_unique_call 5} {:cexpr "temperature"} boogie_si_record_sol2Bpl_int(temperature_s49);
    call {:si_unique_call 6} {:cexpr "timestamp"} boogie_si_record_sol2Bpl_int(timestamp_s49);
    call {:si_unique_call 7} {:cexpr "newCounterparty"} boogie_si_record_sol2Bpl_ref(newCounterparty_s49);
...
procedure RefrigeratedTransportation_RefrigeratedTransportation_NoBaseCtor(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, device_s169: Ref, supplyChainOwner_s169: Ref, supplyChainObserver_s169: Ref, minHumidity_s169: int, maxHumidity_s169: int, minTemperature_s169: int, maxTemperature_s169: int);
...
implementation {:ForceInline} RefrigeratedTransportation_RefrigeratedTransportation_NoBaseCtor(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, device_s169: Ref, supplyChainOwner_s169: Ref, supplyChainObserver_s169: Ref, minHumidity_s169: int, maxHumidity_s169: int, minTemperature_s169: int, maxTemperature_s169: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 13} {:cexpr "device"} boogie_si_record_sol2Bpl_ref(device_s169);
    call {:si_unique_call 14} {:cexpr "supplyChainOwner"} boogie_si_record_sol2Bpl_ref(supplyChainOwner_s169);
    call {:si_unique_call 15} {:cexpr "supplyChainObserver"} boogie_si_record_sol2Bpl_ref(supplyChainObserver_s169);
    call {:si_unique_call 16} {:cexpr "minHumidity"} boogie_si_record_sol2Bpl_int(minHumidity_s169);
    call {:si_unique_call 17} {:cexpr "maxHumidity"} boogie_si_record_sol2Bpl_int(maxHumidity_s169);
    call {:si_unique_call 18} {:cexpr "minTemperature"} boogie_si_record_sol2Bpl_int(minTemperature_s169);
    call {:si_unique_call 19} {:cexpr "maxTemperature"} boogie_si_record_sol2Bpl_int(maxTemperature_s169);
...
procedure {:constructor} {:public} RefrigeratedTransportation_RefrigeratedTransportation(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, device_s169: Ref, supplyChainOwner_s169: Ref, supplyChainObserver_s169: Ref, minHumidity_s169: int, maxHumidity_s169: int, minTemperature_s169: int, maxTemperature_s169: int);
  modifies Balance, Owner_RefrigeratedTransportation, InitiatingCounterparty_RefrigeratedTransportation, Counterparty_RefrigeratedTransportation, PreviousCounterparty_RefrigeratedTransportation, Device_RefrigeratedTransportation, SupplyChainOwner_RefrigeratedTransportation, SupplyChainObserver_RefrigeratedTransportation, MinHumidity_RefrigeratedTransportation, MaxHumidity_RefrigeratedTransportation, MinTemperature_RefrigeratedTransportation, MaxTemperature_RefrigeratedTransportation, ComplianceSensorReading_RefrigeratedTransportation, ComplianceStatus_RefrigeratedTransportation, ComplianceDetail_RefrigeratedTransportation, LastSensorUpdateTimestamp_RefrigeratedTransportation, State_RefrigeratedTransportation;



implementation {:ForceInline} RefrigeratedTransportation_RefrigeratedTransportation(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, device_s169: Ref, supplyChainOwner_s169: Ref, supplyChainObserver_s169: Ref, minHumidity_s169: int, maxHumidity_s169: int, minTemperature_s169: int, maxTemperature_s169: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 38} {:cexpr "device"} boogie_si_record_sol2Bpl_ref(device_s169);
    call {:si_unique_call 39} {:cexpr "supplyChainOwner"} boogie_si_record_sol2Bpl_ref(supplyChainOwner_s169);
    call {:si_unique_call 40} {:cexpr "supplyChainObserver"} boogie_si_record_sol2Bpl_ref(supplyChainObserver_s169);
    call {:si_unique_call 41} {:cexpr "minHumidity"} boogie_si_record_sol2Bpl_int(minHumidity_s169);
    call {:si_unique_call 42} {:cexpr "maxHumidity"} boogie_si_record_sol2Bpl_int(maxHumidity_s169);
    call {:si_unique_call 43} {:cexpr "minTemperature"} boogie_si_record_sol2Bpl_int(minTemperature_s169);
    call {:si_unique_call 44} {:cexpr "maxTemperature"} boogie_si_record_sol2Bpl_int(maxTemperature_s169);
    call {:si_unique_call 45} {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
    call {:si_unique_call 46} RefrigeratedTransportation_RefrigeratedTransportation_NoBaseCtor(this, msgsender_MSG, msgvalue_MSG, device_s169, supplyChainOwner_s169, supplyChainObserver_s169, minHumidity_s169, maxHumidity_s169, minTemperature_s169, maxTemperature_s169);
    return;
}



procedure {:public} IngestTelemetry_RefrigeratedTransportation(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, humidity_s272: int, temperature_s272: int, timestamp_s272: int);
...
implementation {:ForceInline} IngestTelemetry_RefrigeratedTransportation(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, humidity_s272: int, temperature_s272: int, timestamp_s272: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 51} {:cexpr "humidity"} boogie_si_record_sol2Bpl_int(humidity_s272);
    call {:si_unique_call 52} {:cexpr "temperature"} boogie_si_record_sol2Bpl_int(temperature_s272);
    call {:si_unique_call 53} {:cexpr "timestamp"} boogie_si_record_sol2Bpl_int(timestamp_s272);
  ...
  anon15_Then:
    assume {:partition} humidity_s272 > MaxHumidity_RefrigeratedTransportation[this] || humidity_s272 < MinHumidity_RefrigeratedTransportation[this];
  ...
  anon16_Then:
    assume {:partition} temperature_s272 > MaxTemperature_RefrigeratedTransportation[this] || temperature_s272 < MinTemperature_RefrigeratedTransportation[this];
...
procedure {:public} TransferResponsibility_RefrigeratedTransportation(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s337: Ref);
...
implementation {:ForceInline} TransferResponsibility_RefrigeratedTransportation(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s337: Ref)
{
  ...
  anon0:
    ...
    call {:si_unique_call 66} {:cexpr "newCounterparty"} boogie_si_record_sol2Bpl_ref(newCounterparty_s337);
  ...
  anon14_Then:
    assume {:partition} newCounterparty_s337 == Device_RefrigeratedTransportation[this];
...
implementation CorralChoice_RefrigeratedTransportation(this: Ref)
{
  ...
  anon5_Then:
    ...
    call {:si_unique_call 77} validCombination0_RefrigeratedTransportation(this, msgsender_MSG, msgvalue_MSG, humidity_s49, temperature_s49, timestamp_s49, newCounterparty_s49);
    return;
  ...
  anon6_Then:
    ...
    call {:si_unique_call 78} IngestTelemetry_RefrigeratedTransportation(this, msgsender_MSG, msgvalue_MSG, humidity_s272, temperature_s272, timestamp_s272);
    return;
  ...
  anon7_Then:
    ...
    call {:si_unique_call 79} TransferResponsibility_RefrigeratedTransportation(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s337);
    return;
...
implementation CorralEntry_RefrigeratedTransportation()
{
  ...
  anon0:
    ...
    call {:si_unique_call 82} RefrigeratedTransportation_RefrigeratedTransportation(this, msgsender_MSG, msgvalue_MSG, device_s169, supplyChainOwner_s169, supplyChainObserver_s169, minHumidity_s169, maxHumidity_s169, minTemperature_s169, maxTemperature_s169);
    goto anon2_LoopHead;
