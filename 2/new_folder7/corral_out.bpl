...
procedure {:public} vcinitx0_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s25: Ref);



procedure {:public} vcinitx1_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s45: Ref);



procedure {:public} vcinitx2_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s69: Ref);



procedure {:public} vcinitx3_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s89: Ref);



procedure {:public} vcinitx4_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s113: Ref);



procedure {:public} vcinitx5_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s133: Ref);



implementation {:ForceInline} vcinitx5_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s133: Ref)
{
  ...
  anon0:
    ...
    call {:si_unique_call 4} {:cexpr "newCounterparty"} boogie_si_record_sol2Bpl_ref(newCounterparty_s133);
...
procedure BasicProvenance_BasicProvenance_NoBaseCtor(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, supplyChainOwner_s179: Ref, supplyChainObserver_s179: Ref);
...
implementation {:ForceInline} BasicProvenance_BasicProvenance_NoBaseCtor(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, supplyChainOwner_s179: Ref, supplyChainObserver_s179: Ref)
{
  ...
  anon0:
    ...
    call {:si_unique_call 10} {:cexpr "supplyChainOwner"} boogie_si_record_sol2Bpl_ref(supplyChainOwner_s179);
    call {:si_unique_call 11} {:cexpr "supplyChainObserver"} boogie_si_record_sol2Bpl_ref(supplyChainObserver_s179);
  ...
  corral_source_split_7:
    SupplyChainOwner_BasicProvenance[this] := supplyChainOwner_s179;
  ...
  corral_source_split_8:
    SupplyChainObserver_BasicProvenance[this] := supplyChainObserver_s179;
...
procedure {:constructor} {:public} BasicProvenance_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, supplyChainOwner_s179: Ref, supplyChainObserver_s179: Ref);
  modifies Balance, InitiatingCounterparty_BasicProvenance, Counterparty_BasicProvenance, PreviousCounterparty_BasicProvenance, SupplyChainOwner_BasicProvenance, SupplyChainObserver_BasicProvenance, State_BasicProvenance;



implementation {:ForceInline} BasicProvenance_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, supplyChainOwner_s179: Ref, supplyChainObserver_s179: Ref)
{
  ...
  anon0:
    ...
    call {:si_unique_call 21} {:cexpr "supplyChainOwner"} boogie_si_record_sol2Bpl_ref(supplyChainOwner_s179);
    call {:si_unique_call 22} {:cexpr "supplyChainObserver"} boogie_si_record_sol2Bpl_ref(supplyChainObserver_s179);
    call {:si_unique_call 23} {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
    call {:si_unique_call 24} BasicProvenance_BasicProvenance_NoBaseCtor(this, msgsender_MSG, msgvalue_MSG, supplyChainOwner_s179, supplyChainObserver_s179);
    return;
}



procedure {:public} TransferResponsibility_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s218: Ref);
  modifies State_BasicProvenance, PreviousCounterparty_BasicProvenance, Counterparty_BasicProvenance;



implementation {:ForceInline} TransferResponsibility_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s218: Ref)
{
  ...
  anon0:
    ...
    call {:si_unique_call 29} {:cexpr "newCounterparty"} boogie_si_record_sol2Bpl_ref(newCounterparty_s218);
  ...
  corral_source_split_20:
    Counterparty_BasicProvenance[this] := newCounterparty_s218;
...
implementation CorralChoice_BasicProvenance(this: Ref)
{
  ...
  var newCounterparty_s69: Ref;
  var newCounterparty_s89: Ref;
  var newCounterparty_s113: Ref;
  var newCounterparty_s133: Ref;
  var supplyChainOwner_s179: Ref;
  var supplyChainObserver_s179: Ref;
  var newCounterparty_s218: Ref;
  var tmpNow: int;
  ...
  anon0:
    ...
    havoc newCounterparty_s69;
    havoc newCounterparty_s89;
    havoc newCounterparty_s113;
    havoc newCounterparty_s133;
    havoc supplyChainOwner_s179;
    havoc supplyChainObserver_s179;
    havoc newCounterparty_s218;
    havoc tmpNow;
    tmpNow := now;
    havoc now;
    assume now > tmpNow;
  ...
  anon9_Then:
    ...
    call {:si_unique_call 40} vcinitx0_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s25);
    return;
  ...
  anon10_Then:
    ...
    call {:si_unique_call 41} vcinitx1_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s45);
    return;
  ...
  anon11_Then:
    ...
    call {:si_unique_call 42} vcinitx2_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s69);
    return;
  ...
  anon12_Then:
    ...
    call {:si_unique_call 43} vcinitx3_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s89);
    return;
  ...
  anon13_Then:
    ...
    call {:si_unique_call 44} vcinitx4_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s113);
    return;
  ...
  anon14_Then:
    ...
    call {:si_unique_call 45} vcinitx5_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s133);
    return;
  ...
  anon15_Then:
    ...
    call {:si_unique_call 46} TransferResponsibility_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s218);
    return;
  ...
  anon16_Then:
    ...
    call {:si_unique_call 47} Complete_BasicProvenance(this, msgsender_MSG, msgvalue_MSG);
    return;
...
implementation CorralEntry_BasicProvenance()
{
  ...
  anon0:
    call {:si_unique_call 48} this := FreshRefGenerator();
    assume now >= 0;
    assume DType[this] == BasicProvenance;
    call {:si_unique_call 49} BasicProvenance_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, supplyChainOwner_s179, supplyChainObserver_s179);
    goto anon2_LoopHead;
  ...
  anon2_LoopBody:
    ...
    call {:si_unique_call 50} CorralChoice_BasicProvenance(this);
    goto anon2_LoopHead;
