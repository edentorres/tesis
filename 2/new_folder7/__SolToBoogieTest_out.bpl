...
procedure {:public} {:inline 1} vcinitx0_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s25: Ref);
procedure {:public} {:inline 1} vcinitx1_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s45: Ref);
procedure {:public} {:inline 1} vcinitx2_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s69: Ref);
procedure {:public} {:inline 1} vcinitx3_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s89: Ref);
procedure {:public} {:inline 1} vcinitx4_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s113: Ref);
procedure {:public} {:inline 1} vcinitx5_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s133: Ref);
implementation vcinitx5_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s133: Ref)
{
...
call  {:cexpr "newCounterparty"} boogie_si_record_sol2Bpl_ref(newCounterparty_s133);
...
procedure {:inline 1} BasicProvenance_BasicProvenance_NoBaseCtor(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, supplyChainOwner_s179: Ref, supplyChainObserver_s179: Ref);
implementation BasicProvenance_BasicProvenance_NoBaseCtor(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, supplyChainOwner_s179: Ref, supplyChainObserver_s179: Ref)
{
...
call  {:cexpr "msg.sender"} boogie_si_record_sol2Bpl_ref(msgsender_MSG);
call  {:cexpr "msg.value"} boogie_si_record_sol2Bpl_int(msgvalue_MSG);
call  {:cexpr "supplyChainOwner"} boogie_si_record_sol2Bpl_ref(supplyChainOwner_s179);
call  {:cexpr "supplyChainObserver"} boogie_si_record_sol2Bpl_ref(supplyChainObserver_s179);
call  {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
...
procedure {:constructor} {:public} {:inline 1} BasicProvenance_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, supplyChainOwner_s179: Ref, supplyChainObserver_s179: Ref);
implementation BasicProvenance_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, supplyChainOwner_s179: Ref, supplyChainObserver_s179: Ref)
{
call  {:cexpr "_verisolFirstArg"} boogie_si_record_sol2Bpl_bool(false);
call  {:cexpr "this"} boogie_si_record_sol2Bpl_ref(this);
call  {:cexpr "msg.sender"} boogie_si_record_sol2Bpl_ref(msgsender_MSG);
...
call  {:cexpr "supplyChainObserver"} boogie_si_record_sol2Bpl_ref(supplyChainObserver_s179);
call  {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
call BasicProvenance_BasicProvenance_NoBaseCtor(this, msgsender_MSG, msgvalue_MSG, supplyChainOwner_s179, supplyChainObserver_s179);
}

procedure {:public} {:inline 1} TransferResponsibility_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s218: Ref);
implementation TransferResponsibility_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s218: Ref)
{
call  {:cexpr "_verisolFirstArg"} boogie_si_record_sol2Bpl_bool(false);
call  {:cexpr "this"} boogie_si_record_sol2Bpl_ref(this);
call  {:cexpr "msg.sender"} boogie_si_record_sol2Bpl_ref(msgsender_MSG);
call  {:cexpr "msg.value"} boogie_si_record_sol2Bpl_int(msgvalue_MSG);
call  {:cexpr "newCounterparty"} boogie_si_record_sol2Bpl_ref(newCounterparty_s218);
call  {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder7/CombinationsTemp7.sol"} {:sourceLine 51} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder7/CombinationsTemp7.sol"} {:sourceLine 51} (true);
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder7/CombinationsTemp7.sol"} {:sourceLine 56} (true);
...
call  {:cexpr "msg.value"} boogie_si_record_sol2Bpl_int(msgvalue_MSG);
call  {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder7/CombinationsTemp7.sol"} {:sourceLine 67} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder7/CombinationsTemp7.sol"} {:sourceLine 67} (true);
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder7/CombinationsTemp7.sol"} {:sourceLine 72} (true);
...
call BasicProvenance_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, supplyChainOwner_s179, supplyChainObserver_s179);
while (true)
...
if ((choice) == (8)) {
call vcinitx0_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s25);
} else if ((choice) == (7)) {
call vcinitx1_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s45);
} else if ((choice) == (6)) {
call vcinitx2_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s69);
} else if ((choice) == (5)) {
call vcinitx3_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s89);
} else if ((choice) == (4)) {
call vcinitx4_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s113);
} else if ((choice) == (3)) {
call vcinitx5_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s133);
} else if ((choice) == (2)) {
call TransferResponsibility_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s218);
} else if ((choice) == (1)) {
