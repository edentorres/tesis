...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder7/CombinationsTemp7.sol"} {:sourceLine 5} (true);
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder7/CombinationsTemp7.sol"} {:sourceLine 8} (true);
assert (false);
}
...
Description_SimpleMarketplace[this] := 1029445598;
...
call  {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder7/CombinationsTemp7.sol"} {:sourceLine 28} (true);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder7/CombinationsTemp7.sol"} {:sourceLine 29} (true);
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder7/CombinationsTemp7.sol"} {:sourceLine 30} (true);
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder7/CombinationsTemp7.sol"} {:sourceLine 31} (true);
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder7/CombinationsTemp7.sol"} {:sourceLine 52} (true);
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder7/CombinationsTemp7.sol"} {:sourceLine 81} (true);
