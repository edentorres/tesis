...
procedure {:public} {:inline 1} vc0_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s27: Ref);
implementation vc0_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s27: Ref)
{
...
call  {:cexpr "newCounterparty"} boogie_si_record_sol2Bpl_ref(newCounterparty_s27);
...
procedure {:inline 1} BasicProvenance_BasicProvenance_NoBaseCtor(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, supplyChainOwner_s73: Ref, supplyChainObserver_s73: Ref);
implementation BasicProvenance_BasicProvenance_NoBaseCtor(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, supplyChainOwner_s73: Ref, supplyChainObserver_s73: Ref)
{
...
call  {:cexpr "msg.sender"} boogie_si_record_sol2Bpl_ref(msgsender_MSG);
call  {:cexpr "msg.value"} boogie_si_record_sol2Bpl_int(msgvalue_MSG);
call  {:cexpr "supplyChainOwner"} boogie_si_record_sol2Bpl_ref(supplyChainOwner_s73);
call  {:cexpr "supplyChainObserver"} boogie_si_record_sol2Bpl_ref(supplyChainObserver_s73);
call  {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
...
SupplyChainOwner_BasicProvenance[this] := supplyChainOwner_s73;
...
SupplyChainObserver_BasicProvenance[this] := supplyChainObserver_s73;
...
procedure {:constructor} {:public} {:inline 1} BasicProvenance_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, supplyChainOwner_s73: Ref, supplyChainObserver_s73: Ref);
implementation BasicProvenance_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, supplyChainOwner_s73: Ref, supplyChainObserver_s73: Ref)
{
call  {:cexpr "_verisolFirstArg"} boogie_si_record_sol2Bpl_bool(false);
call  {:cexpr "this"} boogie_si_record_sol2Bpl_ref(this);
call  {:cexpr "msg.sender"} boogie_si_record_sol2Bpl_ref(msgsender_MSG);
...
call  {:cexpr "supplyChainObserver"} boogie_si_record_sol2Bpl_ref(supplyChainObserver_s73);
call  {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
call BasicProvenance_BasicProvenance_NoBaseCtor(this, msgsender_MSG, msgvalue_MSG, supplyChainOwner_s73, supplyChainObserver_s73);
}

procedure {:public} {:inline 1} TransferResponsibility_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s112: Ref);
implementation TransferResponsibility_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s112: Ref)
{
call  {:cexpr "_verisolFirstArg"} boogie_si_record_sol2Bpl_bool(false);
call  {:cexpr "this"} boogie_si_record_sol2Bpl_ref(this);
call  {:cexpr "msg.sender"} boogie_si_record_sol2Bpl_ref(msgsender_MSG);
call  {:cexpr "msg.value"} boogie_si_record_sol2Bpl_int(msgvalue_MSG);
call  {:cexpr "newCounterparty"} boogie_si_record_sol2Bpl_ref(newCounterparty_s112);
call  {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
...
Counterparty_BasicProvenance[this] := newCounterparty_s112;
call  {:cexpr "Counterparty"} boogie_si_record_sol2Bpl_ref(Counterparty_BasicProvenance[this]);
}
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder4/CombinationsTemp4.sol"} {:sourceLine 51} (true);
assume (false);
}
...
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder4/CombinationsTemp4.sol"} {:sourceLine 55} (true);
PreviousCounterparty_BasicProvenance[this] := Counterparty_BasicProvenance[this];
call  {:cexpr "PreviousCounterparty"} boogie_si_record_sol2Bpl_ref(PreviousCounterparty_BasicProvenance[this]);
assert {:first} {:sourceFile "/Users/etorres/Proyectos/verisol-test/2/new_folder4/CombinationsTemp4.sol"} {:sourceLine 56} (true);
__var_1 := null;
...
var supplyChainOwner_s73: Ref;
var supplyChainObserver_s73: Ref;
var newCounterparty_s112: Ref;
var tmpNow: int;
assume ((now) >= (0));
assume ((DType[this]) == (BasicProvenance));
call BasicProvenance_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, supplyChainOwner_s73, supplyChainObserver_s73);
while (true)
...
havoc supplyChainOwner_s73;
havoc supplyChainObserver_s73;
havoc newCounterparty_s112;
havoc tmpNow;
tmpNow := now;
havoc now;
assume ((now) > (tmpNow));
...
if ((choice) == (3)) {
call vc0_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s27);
} else if ((choice) == (2)) {
call TransferResponsibility_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s112);
} else if ((choice) == (1)) {
