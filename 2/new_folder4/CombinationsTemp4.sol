...
function validCombination0x0x3(uint256 offerPrice, address inspector, address appraiser, string memory description, uint256 price) public {
//Remplazar acá 
require(true && !(State == StateType.Active) && !(State == StateType.Active) && State == StateType.OfferPlaced && (State == StateType.OfferPlaced || State == StateType.PendingInspection || State == StateType.Inspected || State == StateType.Appraised && State == StateType.NotionalAcceptance || State == StateType.BuyerAccepted) && true && State == StateType.OfferPlaced && (State == StateType.OfferPlaced || State == StateType.PendingInspection || State == StateType.Inspected || State == StateType.Appraised || State == StateType.NotionalAcceptance || State == StateType.SellerAccepted) && (State != StateType.PendingInspection || State != StateType.Inspected) && (State != StateType.PendingInspection || State != StateType.Appraised));
require(InstanceOwner == msg.sender);
AcceptOffer();
...
function validCombination0x0x4(uint256 offerPrice, address inspector, address appraiser, string memory description, uint256 price) public {
//Remplazar acá 
require(true && !(State == StateType.Active) && !(State == StateType.Active) && State == StateType.OfferPlaced && (State == StateType.OfferPlaced || State == StateType.PendingInspection || State == StateType.Inspected || State == StateType.Appraised && State == StateType.NotionalAcceptance || State == StateType.BuyerAccepted) && true && State == StateType.OfferPlaced && (State == StateType.OfferPlaced || State == StateType.PendingInspection || State == StateType.Inspected || State == StateType.Appraised || State == StateType.NotionalAcceptance || State == StateType.SellerAccepted) && (State != StateType.PendingInspection || State != StateType.Inspected) && (State != StateType.PendingInspection || State != StateType.Appraised));
require(InstanceOwner == msg.sender);
Reject();
...
function validCombination0x0x6(uint256 offerPrice, address inspector, address appraiser, string memory description, uint256 price) public {
//Remplazar acá 
require(true && !(State == StateType.Active) && !(State == StateType.Active) && State == StateType.OfferPlaced && (State == StateType.OfferPlaced || State == StateType.PendingInspection || State == StateType.Inspected || State == StateType.Appraised && State == StateType.NotionalAcceptance || State == StateType.BuyerAccepted) && true && State == StateType.OfferPlaced && (State == StateType.OfferPlaced || State == StateType.PendingInspection || State == StateType.Inspected || State == StateType.Appraised || State == StateType.NotionalAcceptance || State == StateType.SellerAccepted) && (State != StateType.PendingInspection || State != StateType.Inspected) && (State != StateType.PendingInspection || State != StateType.Appraised));
...
function validCombination0x1x3(uint256 offerPrice, address inspector, address appraiser, string memory description, uint256 price) public {
//Remplazar acá 
require(true && !(State == StateType.Active) && !(State == StateType.Active) && State == StateType.OfferPlaced && (State == StateType.OfferPlaced || State == StateType.PendingInspection || State == StateType.Inspected || State == StateType.Appraised && State == StateType.NotionalAcceptance || State == StateType.BuyerAccepted) && true && State == StateType.OfferPlaced && (State == StateType.OfferPlaced || State == StateType.PendingInspection || State == StateType.Inspected || State == StateType.Appraised || State == StateType.NotionalAcceptance || State == StateType.SellerAccepted) && (State != StateType.PendingInspection || State != StateType.Inspected) && (State != StateType.PendingInspection || State != StateType.Appraised));
require(InstanceOwner == msg.sender);
AcceptOffer();
...
function validCombination0x1x4(uint256 offerPrice, address inspector, address appraiser, string memory description, uint256 price) public {
//Remplazar acá 
require(true && !(State == StateType.Active) && !(State == StateType.Active) && State == StateType.OfferPlaced && (State == StateType.OfferPlaced || State == StateType.PendingInspection || State == StateType.Inspected || State == StateType.Appraised && State == StateType.NotionalAcceptance || State == StateType.BuyerAccepted) && true && State == StateType.OfferPlaced && (State == StateType.OfferPlaced || State == StateType.PendingInspection || State == StateType.Inspected || State == StateType.Appraised || State == StateType.NotionalAcceptance || State == StateType.SellerAccepted) && (State != StateType.PendingInspection || State != StateType.Inspected) && (State != StateType.PendingInspection || State != StateType.Appraised));
require(InstanceOwner == msg.sender);
Reject();
...
function validCombination0x1x6(uint256 offerPrice, address inspector, address appraiser, string memory description, uint256 price) public {
//Remplazar acá 
require(true && !(State == StateType.Active) && !(State == StateType.Active) && State == StateType.OfferPlaced && (State == StateType.OfferPlaced || State == StateType.PendingInspection || State == StateType.Inspected || State == StateType.Appraised && State == StateType.NotionalAcceptance || State == StateType.BuyerAccepted) && true && State == StateType.OfferPlaced && (State == StateType.OfferPlaced || State == StateType.PendingInspection || State == StateType.Inspected || State == StateType.Appraised || State == StateType.NotionalAcceptance || State == StateType.SellerAccepted) && (State != StateType.PendingInspection || State != StateType.Inspected) && (State != StateType.PendingInspection || State != StateType.Appraised));
require(InstanceBuyer == msg.sender && offerPrice != 0);
ModifyOffer(offerPrice);
...
function validCombination0x2x3(uint256 offerPrice, address inspector, address appraiser, string memory description, uint256 price) public {
//Remplazar acá 
require(true && !(State == StateType.Active) && !(State == StateType.Active) && State == StateType.OfferPlaced && (State == StateType.OfferPlaced || State == StateType.PendingInspection || State == StateType.Inspected || State == StateType.Appraised && State == StateType.NotionalAcceptance || State == StateType.BuyerAccepted) && true && State == StateType.OfferPlaced && (State == StateType.OfferPlaced || State == StateType.PendingInspection || State == StateType.Inspected || State == StateType.Appraised || State == StateType.NotionalAcceptance || State == StateType.SellerAccepted) && (State != StateType.PendingInspection || State != StateType.Inspected) && (State != StateType.PendingInspection || State != StateType.Appraised));
require(InstanceOwner == msg.sender);
AcceptOffer();
...
function validCombination0x2x4(uint256 offerPrice, address inspector, address appraiser, string memory description, uint256 price) public {
//Remplazar acá 
require(true && !(State == StateType.Active) && !(State == StateType.Active) && State == StateType.OfferPlaced && (State == StateType.OfferPlaced || State == StateType.PendingInspection || State == StateType.Inspected || State == StateType.Appraised && State == StateType.NotionalAcceptance || State == StateType.BuyerAccepted) && true && State == StateType.OfferPlaced && (State == StateType.OfferPlaced || State == StateType.PendingInspection || State == StateType.Inspected || State == StateType.Appraised || State == StateType.NotionalAcceptance || State == StateType.SellerAccepted) && (State != StateType.PendingInspection || State != StateType.Inspected) && (State != StateType.PendingInspection || State != StateType.Appraised));
require(InstanceOwner == msg.sender);
Reject();
...
function validCombination0x2x6(uint256 offerPrice, address inspector, address appraiser, string memory description, uint256 price) public {
//Remplazar acá 
require(true && !(State == StateType.Active) && !(State == StateType.Active) && State == StateType.OfferPlaced && (State == StateType.OfferPlaced || State == StateType.PendingInspection || State == StateType.Inspected || State == StateType.Appraised && State == StateType.NotionalAcceptance || State == StateType.BuyerAccepted) && true && State == StateType.OfferPlaced && (State == StateType.OfferPlaced || State == StateType.PendingInspection || State == StateType.Inspected || State == StateType.Appraised || State == StateType.NotionalAcceptance || State == StateType.SellerAccepted) && (State != StateType.PendingInspection || State != StateType.Inspected) && (State != StateType.PendingInspection || State != StateType.Appraised));
require(InstanceBuyer == msg.sender && offerPrice != 0);
ModifyOffer(offerPrice);
...
function validCombination0x3x3(uint256 offerPrice, address inspector, address appraiser, string memory description, uint256 price) public {
//Remplazar acá 
require(true && !(State == StateType.Active) && !(State == StateType.Active) && State == StateType.OfferPlaced && (State == StateType.OfferPlaced || State == StateType.PendingInspection || State == StateType.Inspected || State == StateType.Appraised && State == StateType.NotionalAcceptance || State == StateType.BuyerAccepted) && true && State == StateType.OfferPlaced && (State == StateType.OfferPlaced || State == StateType.PendingInspection || State == StateType.Inspected || State == StateType.Appraised || State == StateType.NotionalAcceptance || State == StateType.SellerAccepted) && (State != StateType.PendingInspection || State != StateType.Inspected) && (State != StateType.PendingInspection || State != StateType.Appraised));
require(InstanceOwner == msg.sender);
AcceptOffer();
...
function validCombination0x3x4(uint256 offerPrice, address inspector, address appraiser, string memory description, uint256 price) public {
//Remplazar acá 
require(true && !(State == StateType.Active) && !(State == StateType.Active) && State == StateType.OfferPlaced && (State == StateType.OfferPlaced || State == StateType.PendingInspection || State == StateType.Inspected || State == StateType.Appraised && State == StateType.NotionalAcceptance || State == StateType.BuyerAccepted) && true && State == StateType.OfferPlaced && (State == StateType.OfferPlaced || State == StateType.PendingInspection || State == StateType.Inspected || State == StateType.Appraised || State == StateType.NotionalAcceptance || State == StateType.SellerAccepted) && (State != StateType.PendingInspection || State != StateType.Inspected) && (State != StateType.PendingInspection || State != StateType.Appraised));
require(InstanceOwner == msg.sender);
Reject();
...
function validCombination0x3x6(uint256 offerPrice, address inspector, address appraiser, string memory description, uint256 price) public {
//Remplazar acá 
require(true && !(State == StateType.Active) && !(State == StateType.Active) && State == StateType.OfferPlaced && (State == StateType.OfferPlaced || State == StateType.PendingInspection || State == StateType.Inspected || State == StateType.Appraised && State == StateType.NotionalAcceptance || State == StateType.BuyerAccepted) && true && State == StateType.OfferPlaced && (State == StateType.OfferPlaced || State == StateType.PendingInspection || State == StateType.Inspected || State == StateType.Appraised || State == StateType.NotionalAcceptance || State == StateType.SellerAccepted) && (State != StateType.PendingInspection || State != StateType.Inspected) && (State != StateType.PendingInspection || State != StateType.Appraised));
require(InstanceBuyer == msg.sender && offerPrice != 0);
ModifyOffer(offerPrice);
...
function validCombination0x4x3(uint256 offerPrice, address inspector, address appraiser, string memory description, uint256 price) public {
//Remplazar acá 
require(true && !(State == StateType.Active) && !(State == StateType.Active) && State == StateType.OfferPlaced && (State == StateType.OfferPlaced || State == StateType.PendingInspection || State == StateType.Inspected || State == StateType.Appraised && State == StateType.NotionalAcceptance || State == StateType.BuyerAccepted) && true && State == StateType.OfferPlaced && (State == StateType.OfferPlaced || State == StateType.PendingInspection || State == StateType.Inspected || State == StateType.Appraised || State == StateType.NotionalAcceptance || State == StateType.SellerAccepted) && (State != StateType.PendingInspection || State != StateType.Inspected) && (State != StateType.PendingInspection || State != StateType.Appraised));
require(InstanceOwner == msg.sender);
AcceptOffer();
...
function validCombination0x4x4(uint256 offerPrice, address inspector, address appraiser, string memory description, uint256 price) public {
//Remplazar acá 
require(true && !(State == StateType.Active) && !(State == StateType.Active) && State == StateType.OfferPlaced && (State == StateType.OfferPlaced || State == StateType.PendingInspection || State == StateType.Inspected || State == StateType.Appraised && State == StateType.NotionalAcceptance || State == StateType.BuyerAccepted) && true && State == StateType.OfferPlaced && (State == StateType.OfferPlaced || State == StateType.PendingInspection || State == StateType.Inspected || State == StateType.Appraised || State == StateType.NotionalAcceptance || State == StateType.SellerAccepted) && (State != StateType.PendingInspection || State != StateType.Inspected) && (State != StateType.PendingInspection || State != StateType.Appraised));
require(InstanceOwner == msg.sender);
Reject();
...
function validCombination0x4x6(uint256 offerPrice, address inspector, address appraiser, string memory description, uint256 price) public {
//Remplazar acá 
require(true && !(State == StateType.Active) && !(State == StateType.Active) && State == StateType.OfferPlaced && (State == StateType.OfferPlaced || State == StateType.PendingInspection || State == StateType.Inspected || State == StateType.Appraised && State == StateType.NotionalAcceptance || State == StateType.BuyerAccepted) && true && State == StateType.OfferPlaced && (State == StateType.OfferPlaced || State == StateType.PendingInspection || State == StateType.Inspected || State == StateType.Appraised || State == StateType.NotionalAcceptance || State == StateType.SellerAccepted) && (State != StateType.PendingInspection || State != StateType.Inspected) && (State != StateType.PendingInspection || State != StateType.Appraised));
require(InstanceBuyer == msg.sender && offerPrice != 0);
ModifyOffer(offerPrice);
