...
procedure {:public} validCombination38_AssetTransfer(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, offerPrice_s5810: int, inspector_s5810: Ref, appraiser_s5810: Ref, description_s5810: int, price_s5810: int);



procedure {:public} validCombination39_AssetTransfer(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, offerPrice_s5957: int, inspector_s5957: Ref, appraiser_s5957: Ref, description_s5957: int, price_s5957: int);



procedure {:public} validCombination40_AssetTransfer(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, offerPrice_s6104: int, inspector_s6104: Ref, appraiser_s6104: Ref, description_s6104: int, price_s6104: int);



procedure {:public} validCombination41_AssetTransfer(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, offerPrice_s6251: int, inspector_s6251: Ref, appraiser_s6251: Ref, description_s6251: int, price_s6251: int);



implementation {:ForceInline} validCombination41_AssetTransfer(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, offerPrice_s6251: int, inspector_s6251: Ref, appraiser_s6251: Ref, description_s6251: int, price_s6251: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 4} {:cexpr "offerPrice"} boogie_si_record_sol2Bpl_int(offerPrice_s6251);
    call {:si_unique_call 5} {:cexpr "inspector"} boogie_si_record_sol2Bpl_ref(inspector_s6251);
    call {:si_unique_call 6} {:cexpr "appraiser"} boogie_si_record_sol2Bpl_ref(appraiser_s6251);
    call {:si_unique_call 7} {:cexpr "description"} boogie_si_record_sol2Bpl_int(description_s6251);
    call {:si_unique_call 8} {:cexpr "price"} boogie_si_record_sol2Bpl_int(price_s6251);
...
procedure AssetTransfer_AssetTransfer_NoBaseCtor(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, description_s6304: int, price_s6304: int);
...
implementation {:ForceInline} AssetTransfer_AssetTransfer_NoBaseCtor(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, description_s6304: int, price_s6304: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 14} {:cexpr "description"} boogie_si_record_sol2Bpl_int(description_s6304);
    call {:si_unique_call 15} {:cexpr "price"} boogie_si_record_sol2Bpl_int(price_s6304);
...
procedure {:constructor} {:public} AssetTransfer_AssetTransfer(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, description_s6304: int, price_s6304: int);
  modifies Balance, InstanceOwner_AssetTransfer, Description_AssetTransfer, AskingPrice_AssetTransfer, InstanceBuyer_AssetTransfer, OfferPrice_AssetTransfer, InstanceInspector_AssetTransfer, InstanceAppraiser_AssetTransfer, State_AssetTransfer;



implementation {:ForceInline} AssetTransfer_AssetTransfer(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, description_s6304: int, price_s6304: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 24} {:cexpr "description"} boogie_si_record_sol2Bpl_int(description_s6304);
    call {:si_unique_call 25} {:cexpr "price"} boogie_si_record_sol2Bpl_int(price_s6304);
    call {:si_unique_call 26} {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
    call {:si_unique_call 27} AssetTransfer_AssetTransfer_NoBaseCtor(this, msgsender_MSG, msgvalue_MSG, description_s6304, price_s6304);
    return;
}
...
procedure {:public} Modify_AssetTransfer(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, description_s6356: int, price_s6356: int);
  modifies Description_AssetTransfer, AskingPrice_AssetTransfer;



implementation {:ForceInline} Modify_AssetTransfer(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, description_s6356: int, price_s6356: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 37} {:cexpr "description"} boogie_si_record_sol2Bpl_int(description_s6356);
    call {:si_unique_call 38} {:cexpr "price"} boogie_si_record_sol2Bpl_int(price_s6356);
...
procedure {:public} MakeOffer_AssetTransfer(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, inspector_s6426: Ref, appraiser_s6426: Ref, offerPrice_s6426: int);
...
implementation {:ForceInline} MakeOffer_AssetTransfer(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, inspector_s6426: Ref, appraiser_s6426: Ref, offerPrice_s6426: int)
{
  var __var_1: Ref;
  var __var_2: Ref;
  ...
  anon0:
    ...
    call {:si_unique_call 46} {:cexpr "inspector"} boogie_si_record_sol2Bpl_ref(inspector_s6426);
    call {:si_unique_call 47} {:cexpr "appraiser"} boogie_si_record_sol2Bpl_ref(appraiser_s6426);
    call {:si_unique_call 48} {:cexpr "offerPrice"} boogie_si_record_sol2Bpl_int(offerPrice_s6426);
  ...
  anon7_Then:
    assume {:partition} inspector_s6426 == null || appraiser_s6426 == null || offerPrice_s6426 == 0;
...
procedure {:public} ModifyOffer_AssetTransfer(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, offerPrice_s6650: int);
  modifies OfferPrice_AssetTransfer;



implementation {:ForceInline} ModifyOffer_AssetTransfer(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, offerPrice_s6650: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 74} {:cexpr "offerPrice"} boogie_si_record_sol2Bpl_int(offerPrice_s6650);
  ...
  anon6_Then:
    assume {:partition} InstanceBuyer_AssetTransfer[this] != msgsender_MSG || offerPrice_s6650 == 0;
...
implementation CorralChoice_AssetTransfer(this: Ref)
{
  ...
  anon91_Then:
    ...
    call {:si_unique_call 132} validCombination38_AssetTransfer(this, msgsender_MSG, msgvalue_MSG, offerPrice_s5810, inspector_s5810, appraiser_s5810, description_s5810, price_s5810);
    return;
  ...
  anon92_Then:
    ...
    call {:si_unique_call 133} validCombination39_AssetTransfer(this, msgsender_MSG, msgvalue_MSG, offerPrice_s5957, inspector_s5957, appraiser_s5957, description_s5957, price_s5957);
    return;
  ...
  anon93_Then:
    ...
    call {:si_unique_call 134} validCombination40_AssetTransfer(this, msgsender_MSG, msgvalue_MSG, offerPrice_s6104, inspector_s6104, appraiser_s6104, description_s6104, price_s6104);
    return;
  ...
  anon94_Then:
    ...
    call {:si_unique_call 135} validCombination41_AssetTransfer(this, msgsender_MSG, msgvalue_MSG, offerPrice_s6251, inspector_s6251, appraiser_s6251, description_s6251, price_s6251);
    return;
  ...
  anon96_Then:
    ...
    call {:si_unique_call 137} Modify_AssetTransfer(this, msgsender_MSG, msgvalue_MSG, description_s6356, price_s6356);
    return;
  ...
  anon97_Then:
    ...
    call {:si_unique_call 138} MakeOffer_AssetTransfer(this, msgsender_MSG, msgvalue_MSG, inspector_s6426, appraiser_s6426, offerPrice_s6426);
    return;
  ...
  anon101_Then:
    ...
    call {:si_unique_call 142} ModifyOffer_AssetTransfer(this, msgsender_MSG, msgvalue_MSG, offerPrice_s6650);
    return;
...
implementation CorralEntry_AssetTransfer()
{
  ...
  anon0:
    ...
    call {:si_unique_call 147} AssetTransfer_AssetTransfer(this, msgsender_MSG, msgvalue_MSG, description_s6304, price_s6304);
    goto anon2_LoopHead;
