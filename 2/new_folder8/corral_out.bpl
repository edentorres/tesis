...
procedure {:public} vc0_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s27: Ref);



implementation {:ForceInline} vc0_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s27: Ref)
{
  ...
  anon0:
    ...
    call {:si_unique_call 4} {:cexpr "newCounterparty"} boogie_si_record_sol2Bpl_ref(newCounterparty_s27);
...
procedure BasicProvenance_BasicProvenance_NoBaseCtor(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, supplyChainOwner_s73: Ref, supplyChainObserver_s73: Ref);
...
implementation {:ForceInline} BasicProvenance_BasicProvenance_NoBaseCtor(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, supplyChainOwner_s73: Ref, supplyChainObserver_s73: Ref)
{
  ...
  anon0:
    ...
    call {:si_unique_call 10} {:cexpr "supplyChainOwner"} boogie_si_record_sol2Bpl_ref(supplyChainOwner_s73);
    call {:si_unique_call 11} {:cexpr "supplyChainObserver"} boogie_si_record_sol2Bpl_ref(supplyChainObserver_s73);
...
procedure {:constructor} {:public} BasicProvenance_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, supplyChainOwner_s73: Ref, supplyChainObserver_s73: Ref);
  modifies Balance, InitiatingCounterparty_BasicProvenance, Counterparty_BasicProvenance, PreviousCounterparty_BasicProvenance, SupplyChainOwner_BasicProvenance, SupplyChainObserver_BasicProvenance, State_BasicProvenance;



implementation {:ForceInline} BasicProvenance_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, supplyChainOwner_s73: Ref, supplyChainObserver_s73: Ref)
{
  ...
  anon0:
    ...
    call {:si_unique_call 21} {:cexpr "supplyChainOwner"} boogie_si_record_sol2Bpl_ref(supplyChainOwner_s73);
    call {:si_unique_call 22} {:cexpr "supplyChainObserver"} boogie_si_record_sol2Bpl_ref(supplyChainObserver_s73);
    call {:si_unique_call 23} {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
    call {:si_unique_call 24} BasicProvenance_BasicProvenance_NoBaseCtor(this, msgsender_MSG, msgvalue_MSG, supplyChainOwner_s73, supplyChainObserver_s73);
    return;
}



procedure {:public} TransferResponsibility_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s112: Ref);
  modifies State_BasicProvenance, PreviousCounterparty_BasicProvenance, Counterparty_BasicProvenance;



implementation {:ForceInline} TransferResponsibility_BasicProvenance(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, newCounterparty_s112: Ref)
{
  ...
  anon0:
    ...
    call {:si_unique_call 29} {:cexpr "newCounterparty"} boogie_si_record_sol2Bpl_ref(newCounterparty_s112);
...
implementation CorralChoice_BasicProvenance(this: Ref)
{
  ...
  anon4_Then:
    ...
    call {:si_unique_call 40} vc0_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s27);
    return;
  ...
  anon5_Then:
    ...
    call {:si_unique_call 41} TransferResponsibility_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, newCounterparty_s112);
    return;
...
implementation CorralEntry_BasicProvenance()
{
  ...
  anon0:
    ...
    call {:si_unique_call 44} BasicProvenance_BasicProvenance(this, msgsender_MSG, msgvalue_MSG, supplyChainOwner_s73, supplyChainObserver_s73);
    goto anon2_LoopHead;
