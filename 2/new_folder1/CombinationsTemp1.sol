...
function validCombination0x0x0(int humidity, int temperature, int timestamp, address newCounterparty) public {
//Remplazar acá 
...
function validCombination0x0x1(int humidity, int temperature, int timestamp, address newCounterparty) public {
//Remplazar acá 
require(State != StateType.Completed && State != StateType.OutOfCompliance  && State != StateType.Completed && State != StateType.OutOfCompliance && State != StateType.Completed && State != StateType.OutOfCompliance);
...
function validCombination0x0x2(int humidity, int temperature, int timestamp, address newCounterparty) public {
//Remplazar acá 
require(State != StateType.Completed && State != StateType.OutOfCompliance  && State != StateType.Completed && State != StateType.OutOfCompliance && State != StateType.Completed && State != StateType.OutOfCompliance);
...
function validCombination0x1x0(int humidity, int temperature, int timestamp, address newCounterparty) public {
//Remplazar acá 
require(State != StateType.Completed && State != StateType.OutOfCompliance  && State != StateType.Completed && State != StateType.OutOfCompliance && State != StateType.Completed && State != StateType.OutOfCompliance);
require(Device == msg.sender);
IngestTelemetry(humidity, temperature, timestamp);
...
function validCombination0x1x1(int humidity, int temperature, int timestamp, address newCounterparty) public {
//Remplazar acá 
require(State != StateType.Completed && State != StateType.OutOfCompliance  && State != StateType.Completed && State != StateType.OutOfCompliance && State != StateType.Completed && State != StateType.OutOfCompliance);
require(InitiatingCounterparty == msg.sender && Counterparty == msg.sender && newCounterparty != Device);
TransferResponsibility(newCounterparty);
...
function validCombination0x1x2(int humidity, int temperature, int timestamp, address newCounterparty) public {
//Remplazar acá 
require(State != StateType.Completed && State != StateType.OutOfCompliance  && State != StateType.Completed && State != StateType.OutOfCompliance && State != StateType.Completed && State != StateType.OutOfCompliance);
require(Owner == msg.sender && SupplyChainOwner == msg.sender);
Complete();
