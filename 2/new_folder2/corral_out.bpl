...
procedure {:public} prueba_SimpleMarketplace(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, offerPrice_s60: int);
  modifies StateEnum_SimpleMarketplace;



implementation {:ForceInline} prueba_SimpleMarketplace(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, offerPrice_s60: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 4} {:cexpr "offerPrice"} boogie_si_record_sol2Bpl_int(offerPrice_s60);
...
procedure SimpleMarketplace_SimpleMarketplace_NoBaseCtor(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, description_s107: int, price_s107: int, sender_s107: Ref);
...
implementation {:ForceInline} SimpleMarketplace_SimpleMarketplace_NoBaseCtor(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, description_s107: int, price_s107: int, sender_s107: Ref)
{
  var __var_1: Ref;
  ...
  anon0:
    ...
    Description_SimpleMarketplace[this] := -989211026;
    ...
    call {:si_unique_call 12} {:cexpr "description"} boogie_si_record_sol2Bpl_int(description_s107);
    call {:si_unique_call 13} {:cexpr "price"} boogie_si_record_sol2Bpl_int(price_s107);
    call {:si_unique_call 14} {:cexpr "sender"} boogie_si_record_sol2Bpl_ref(sender_s107);
...
procedure {:constructor} {:public} SimpleMarketplace_SimpleMarketplace(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, description_s107: int, price_s107: int, sender_s107: Ref);
  modifies Balance, InstanceOwner_SimpleMarketplace, Description_SimpleMarketplace, AskingPrice_SimpleMarketplace, Alloc, result_SimpleMarketplace, InstanceBuyer_SimpleMarketplace, OfferPrice_SimpleMarketplace, StateEnum_SimpleMarketplace;



implementation {:ForceInline} SimpleMarketplace_SimpleMarketplace(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, description_s107: int, price_s107: int, sender_s107: Ref)
{
  var __var_1: Ref;
  ...
  anon0:
    ...
    call {:si_unique_call 23} {:cexpr "description"} boogie_si_record_sol2Bpl_int(description_s107);
    call {:si_unique_call 24} {:cexpr "price"} boogie_si_record_sol2Bpl_int(price_s107);
    call {:si_unique_call 25} {:cexpr "sender"} boogie_si_record_sol2Bpl_ref(sender_s107);
    call {:si_unique_call 26} {:cexpr "_verisolLastArg"} boogie_si_record_sol2Bpl_bool(true);
    call {:si_unique_call 27} SimpleMarketplace_SimpleMarketplace_NoBaseCtor(this, msgsender_MSG, msgvalue_MSG, description_s107, price_s107, sender_s107);
    return;
}



procedure {:public} MakeOffer_SimpleMarketplace(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, offerPrice_s153: int);
  modifies InstanceBuyer_SimpleMarketplace, OfferPrice_SimpleMarketplace, StateEnum_SimpleMarketplace;



implementation {:ForceInline} MakeOffer_SimpleMarketplace(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, offerPrice_s153: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 32} {:cexpr "offerPrice"} boogie_si_record_sol2Bpl_int(offerPrice_s153);
  ...
  anon7_Then:
    assume {:partition} offerPrice_s153 == 0;
  ...
  corral_source_split_25:
    OfferPrice_SimpleMarketplace[this] := offerPrice_s153;
...
implementation CorralChoice_SimpleMarketplace(this: Ref)
{
  ...
  var choice: int;
  var offerPrice_s60: int;
  var description_s107: int;
  var price_s107: int;
  var sender_s107: Ref;
  var offerPrice_s153: int;
  var tmpNow: int;
  ...
  anon0:
    ...
    havoc msgvalue_MSG;
    havoc choice;
    havoc offerPrice_s60;
    havoc description_s107;
    havoc price_s107;
    havoc sender_s107;
    havoc offerPrice_s153;
    havoc tmpNow;
    tmpNow := now;
    havoc now;
    assume now > tmpNow;
  ...
  anon5_Then:
    ...
    call {:si_unique_call 46} prueba_SimpleMarketplace(this, msgsender_MSG, msgvalue_MSG, offerPrice_s60);
    return;
  ...
  anon6_Then:
    ...
    call {:si_unique_call 47} MakeOffer_SimpleMarketplace(this, msgsender_MSG, msgvalue_MSG, offerPrice_s153);
    return;
...
implementation CorralEntry_SimpleMarketplace()
{
  ...
  anon0:
    ...
    call {:si_unique_call 51} SimpleMarketplace_SimpleMarketplace(this, msgsender_MSG, msgvalue_MSG, description_s107, price_s107, sender_s107);
    goto anon2_LoopHead;
